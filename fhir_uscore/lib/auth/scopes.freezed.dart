...
class _$ScopesTearOff {
  ...
  _Scopes call(
      {List<Tuple3<Role, UsCoreResourceType, Interaction>>? clinicalScopes,
      bool? openid,
      bool? fhirUser,
      bool? profile,
      bool? offlineAccess,
...
mixin _$Scopes {
  ...
  List<Tuple3<Role, UsCoreResourceType, Interaction>>? get clinicalScopes;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      clinicalScopes: clinicalScopes == freezed
          ...
          : clinicalScopes
              as List<Tuple3<Role, UsCoreResourceType, Interaction>>?,
...
class _$_Scopes extends _Scopes {
  ...
  /// see the clinical scopes class for details
  final List<Tuple3<Role, UsCoreResourceType, Interaction>>? clinicalScopes;
  @override
