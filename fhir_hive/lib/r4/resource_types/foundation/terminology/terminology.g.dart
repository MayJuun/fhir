...
class ConceptMapGroupAdapter extends TypeAdapter<_$_ConceptMapGroup> {
  @override
  final int typeId = 102;

  @override
  _$_ConceptMapGroup read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$_ConceptMapGroup(
      ...
      source: fields[3] as FhirUri?,
      sourceElement: fields[4] as Element?,
      sourceVersion: fields[5] as String?,
      sourceVersionElement: fields[6] as Element?,
      target: fields[7] as FhirUri?,
      targetElement: fields[8] as Element?,
      targetVersion: fields[9] as String?,
      targetVersionElement: fields[10] as Element?,
      element: (fields[11] as List).cast<ConceptMapElement>(),
      unmapped: fields[12] as ConceptMapUnmapped?,
    );
  }

  @override
  void write(BinaryWriter writer, _$_ConceptMapGroup obj) {
    writer
      ..writeByte(13)
      ..writeByte(0)
      ..write(obj.id)
      ...
      ..writeByte(6)
      ..write(obj.sourceVersionElement)
      ..writeByte(7)
      ..write(obj.target)
      ..writeByte(8)
      ...
      ..writeByte(10)
      ..write(obj.targetVersionElement)
      ..writeByte(12)
      ..write(obj.unmapped)
      ..writeByte(1)
      ..write(obj.extension_)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ConceptMapGroupAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
...
class TerminologyCapabilitiesCodeSystemAdapter
    extends TypeAdapter<_$_TerminologyCapabilitiesCodeSystem> {
  @override
  final int typeId = 105;

  @override
  _$_TerminologyCapabilitiesCodeSystem read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$_TerminologyCapabilitiesCodeSystem(
      ...
      extension_: (fields[1] as List?)?.cast<FhirExtension>(),
      modifierExtension: (fields[2] as List?)?.cast<FhirExtension>(),
      uri: fields[3] as Canonical?,
      version: (fields[4] as List?)?.cast<TerminologyCapabilitiesVersion>(),
      subsumption: fields[5] as Boolean?,
      subsumptionElement: fields[6] as Element?,
    );
  }

  @override
  void write(BinaryWriter writer, _$_TerminologyCapabilitiesCodeSystem obj) {
    writer
      ..writeByte(7)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TerminologyCapabilitiesCodeSystemAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
