...
class PlanDefinitionGoalAdapter extends TypeAdapter<_$_PlanDefinitionGoal> {
  @override
  final int typeId = 75;

  @override
  _$_PlanDefinitionGoal read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$_PlanDefinitionGoal(
      ...
      target: (fields[9] as List?)?.cast<PlanDefinitionTarget>(),
    );
  }

  @override
  void write(BinaryWriter writer, _$_PlanDefinitionGoal obj) {
    writer
      ..writeByte(10)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PlanDefinitionGoalAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

class PlanDefinitionConditionAdapter
    extends TypeAdapter<_$_PlanDefinitionCondition> {
  @override
  final int typeId = 76;

  @override
  _$_PlanDefinitionCondition read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, _$_PlanDefinitionCondition obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PlanDefinitionConditionAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
