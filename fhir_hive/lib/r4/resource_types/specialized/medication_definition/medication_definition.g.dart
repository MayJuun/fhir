...
class AdministrableProductDefinitionAdapter
  ...
  _$_AdministrableProductDefinition read(BinaryReader reader) {
    ...
    return _$_AdministrableProductDefinition(
      ...
      meta: fields[4] as FhirMeta?,
      implicitRules: fields[5] as FhirUri?,
      implicitRulesElement: fields[6] as Element?,
      language: fields[7] as Code?,
      languageElement: fields[8] as Element?,
      text: fields[9] as Narrative?,
      contained: (fields[10] as List?)?.cast<Resource>(),
      extension_: (fields[11] as List?)?.cast<FhirExtension>(),
      modifierExtension: (fields[12] as List?)?.cast<FhirExtension>(),
      identifier: (fields[13] as List?)?.cast<Identifier>(),
      status: fields[14] as Code?,
      statusElement: fields[15] as Element?,
      formOf: (fields[16] as List?)?.cast<Reference>(),
      administrableDoseForm: fields[17] as CodeableConcept?,
      unitOfPresentation: fields[18] as CodeableConcept?,
      producedFrom: (fields[19] as List?)?.cast<Reference>(),
      ingredient: (fields[20] as List?)?.cast<CodeableConcept>(),
      device: fields[21] as Reference?,
      property:
          (fields[22] as List?)?.cast<AdministrableProductDefinitionProperty>(),
      routeOfAdministration: (fields[23] as List)
...
class IngredientSubstanceAdapter extends TypeAdapter<_$_IngredientSubstance> {
  @override
  final int typeId = 56;

  @override
  _$_IngredientSubstance read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$_IngredientSubstance(
      ...
      code: fields[3] as CodeableReference,
      strength: (fields[4] as List?)?.cast<IngredientStrength>(),
    );
  }

  @override
  void write(BinaryWriter writer, _$_IngredientSubstance obj) {
    writer
      ..writeByte(5)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is IngredientSubstanceAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
