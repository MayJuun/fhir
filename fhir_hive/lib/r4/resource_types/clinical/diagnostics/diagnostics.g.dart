...
class DiagnosticReportMediaAdapter
    extends TypeAdapter<_$_DiagnosticReportMedia> {
  @override
  final int typeId = 186;

  @override
  _$_DiagnosticReportMedia read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$_DiagnosticReportMedia(
      ...
      commentElement: fields[4] as Element?,
      link: fields[5] as Reference,
    );
  }

  @override
  void write(BinaryWriter writer, _$_DiagnosticReportMedia obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is DiagnosticReportMediaAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
