...
class RequestGroupConditionAdapter
    extends TypeAdapter<_$_RequestGroupCondition> {
  @override
  final int typeId = 209;

  @override
  _$_RequestGroupCondition read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$_RequestGroupCondition(
      ...
      kind: fields[3] as Code?,
      kindElement: fields[4] as Element?,
      expression: fields[5] as Expression?,
    );
  }

  @override
  void write(BinaryWriter writer, _$_RequestGroupCondition obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is RequestGroupConditionAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
