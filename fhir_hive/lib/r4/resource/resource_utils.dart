...
String resourceTypeToString(R4ResourceType resourceType) =>
    resourceTypeToStringMap[resourceType]!;

Type? dartResourceTypeFromString(String type) =>
    dartResourceTypeFromStringMap[type];

Type resourceTypeToDartResourceType(R4ResourceType resourceType) =>
    resourceTypeToDartResourceTypeMap[resourceType]!;

const Map<String, Type> dartResourceTypeFromStringMap = <String, Type>{
  'Account': Account,
...
const Map<R4ResourceType, Type> resourceTypeToDartResourceTypeMap =
    <R4ResourceType, Type>{
  R4ResourceType.Account: Account,
  R4ResourceType.ActivityDefinition: ActivityDefinition,
  R4ResourceType.AdministrableProductDefinition: AdministrableProductDefinition,
  ...
  R4ResourceType.FhirList: FhirList,
