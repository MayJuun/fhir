...
mixin _$Scopes {
  ...
  List<Tuple3<Role, R5ResourceType, Interaction>> get clinicalScopes;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      clinicalScopes: clinicalScopes == freezed
          ...
          : clinicalScopes as List<Tuple3<Role, R5ResourceType, Interaction>>,
...
class _$_Scopes extends _Scopes {
  ...
  /// see the clinical scopes class for details
  final List<Tuple3<Role, R5ResourceType, Interaction>> clinicalScopes;
  @override
