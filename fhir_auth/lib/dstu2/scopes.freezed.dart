...
mixin _$Scopes {
  ...
  List<Tuple3<Role, Dstu2ResourceType, Interaction>> get clinicalScopes;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      clinicalScopes: clinicalScopes == freezed
          ...
          : clinicalScopes
              as List<Tuple3<Role, Dstu2ResourceType, Interaction>>,
...
class _$_Scopes extends _Scopes {
  ...
  /// see the clinical scopes class for details
  final List<Tuple3<Role, Dstu2ResourceType, Interaction>> clinicalScopes;
  @override
