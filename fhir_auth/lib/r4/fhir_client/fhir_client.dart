...
abstract class FhirClient {
  ...
  Future<Response>? put(String url,
          {Map<String, String>? headers, Client? httpClient}) =>
      helper?.put(url, headers: headers, httpClient: httpClient);

  Future<Response>? post(String url,
          {Map<String, String>? headers, Client? httpClient}) =>
      helper?.post(url, headers: headers, httpClient: httpClient);
  ...
  Future<Response>? patch(String url,
          {Map<String, String>? headers, Client? httpClient}) =>
      helper?.patch(url, headers: headers, httpClient: httpClient);
}
