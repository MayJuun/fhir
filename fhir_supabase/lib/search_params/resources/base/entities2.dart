...
class DeviceSearchParams with _$DeviceSearchParams {
  ...
  List<String> toRequest() {
    ...
    if (deviceName.isNotEmpty) {
      for (final element in deviceName) {
        returnStrings.add('device-name${element.toRequest()}');
      }
    }
    ...
    if (model.isNotEmpty) {
      for (final element in model) {
        returnStrings.add('model${element.toRequest()}');
      }
    }
    ...
    if (udiCarrier.isNotEmpty) {
      for (final element in udiCarrier) {
        returnStrings.add('udi-carrier${element.toRequest()}');
      }
    }
    if (udiDi.isNotEmpty) {
      for (final element in udiDi) {
        returnStrings.add('udi-di${element.toRequest()}');
      }
    }
    if (url.isNotEmpty) {
...
class SubstanceSearchParams with _$SubstanceSearchParams {
  ...
  List<String> toRequest() {
    ...
    if (containerIdentifier.isNotEmpty) {
      for (final element in containerIdentifier) {
        returnStrings.add('container-identifier${element.toRequest()}');
      }
    }
    if (expiry.isNotEmpty) {
      for (final element in expiry) {
        returnStrings.add('expiry${element.toRequest()}');
      }
    }
    if (identifier.isNotEmpty) {
      for (final element in identifier) {
    ...
    if (substanceReference.isNotEmpty) {
      for (final element in substanceReference) {
