...
class BundleSearchParams with _$BundleSearchParams {
  ...
  List<String> toRequest() {
    ...
    if (composition.isNotEmpty) {
      for (final element in composition) {
        returnStrings.add('composition${element.toRequest()}');
      }
    }
    if (identifier.isNotEmpty) {
      for (final element in identifier) {
    ...
    if (message.isNotEmpty) {
      for (final element in message) {
        returnStrings.add('message${element.toRequest()}');
      }
    }
    if (timestamp.isNotEmpty) {
      for (final element in timestamp) {
        returnStrings.add('timestamp${element.toRequest()}');
      }
    }
    if (type.isNotEmpty) {
...
class MessageHeaderSearchParams with _$MessageHeaderSearchParams {
  ...
  List<String> toRequest() {
    ...
    if (destinationUri.isNotEmpty) {
      for (final element in destinationUri) {
    ...
    if (responseId.isNotEmpty) {
      for (final element in responseId) {
        returnStrings.add('response-id${element.toRequest()}');
      }
    }
...
class SubscriptionSearchParams with _$SubscriptionSearchParams {
  ...
  List<String> toRequest() {
    ...
    if (criteria.isNotEmpty) {
      for (final element in criteria) {
        returnStrings.add('criteria${element.toRequest()}');
      }
    }
    if (payload.isNotEmpty) {
      for (final element in payload) {
        returnStrings.add('payload${element.toRequest()}');
      }
    }
...
class SubscriptionTopicSearchParams with _$SubscriptionTopicSearchParams {
  ...
  List<String> toRequest() {
    ...
    if (derivedOrSelf.isNotEmpty) {
      for (final element in derivedOrSelf) {
    ...
    if (triggerDescription.isNotEmpty) {
      for (final element in triggerDescription) {
