...
/// This Map helps us create the new Resource. All classes available in FHIR
/// are mapped below (except for primitives). So if you know the class, you
/// know all available fields for it, and what type of fields they should be.
/// This allows us to walk down a path into the resource, identifying the
/// fields to update, and what kind of fields they should be
final fhirFieldMap = {
  'Population': {
