...
class _$_SearchParamReferenceMissing extends _SearchParamReferenceMissing {
  const _$_SearchParamReferenceMissing() : super._();

  @override
  String toString() {
    return 'SearchParamReference.missing()';
  }
...
abstract class _SearchParamReferenceMissing extends SearchParamReference {
  const factory _SearchParamReferenceMissing() = _$_SearchParamReferenceMissing;
