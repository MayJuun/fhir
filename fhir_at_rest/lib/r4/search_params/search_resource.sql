create or replace function internal.search_account()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.subject[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
...
create or replace function internal.search_activitydefinition()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.text'),
      jsonb_path_query(new, '$.type'),
      jsonb_path_query(new, '$.relatedArtifact[*] ? (@.type = ''composed-of'').resource'),
      jsonb_path_query(new, '$.useContext.valueCodeableConcept'),
      jsonb_path_query(new, '$.useContext.valueQuantity'),
      jsonb_path_query(new, '$.useContext.code'),
      jsonb_path_query(new, '$.date'),
      jsonb_path_query(new, '$.relatedArtifact[*] ? (@.type = ''depends-on'').resource'),
      jsonb_path_query(new, '$.relatedArtifact[*] ? (@.type = ''derived-from'').resource'),
      jsonb_path_query(new, '$.description'),
      jsonb_path_query(new, '$.effectivePeriod'),
      jsonb_path_query(new, '$.identifier'),
      jsonb_path_query(new, '$.jurisdiction'),
      jsonb_path_query(new, '$.name'),
      jsonb_path_query(new, '$.relatedArtifact[*] ? (@.type = ''predecessor'').resource'),
      jsonb_path_query(new, '$.publisher'),
      jsonb_path_query(new, '$.status'),
      jsonb_path_query(new, '$.relatedArtifact[*] ? (@.type = ''successor'').resource'),
...
create or replace function internal.search_condition()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.identifier'),
      jsonb_path_query(new, '$.subject[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.abatementAge'),
      jsonb_path_query(new, '$.abatementDateTime'),
      jsonb_path_query(new, '$.abatementString'),
      jsonb_path_query(new, '$.asserter'),
      ...
      jsonb_path_query(new, '$.onsetAge'),
      jsonb_path_query(new, '$.onsetDateTime'),
      jsonb_path_query(new, '$.onsetString'),
      jsonb_path_query(new, '$.recordedDate'),
      jsonb_path_query(new, '$.severity'),
...
create or replace function internal.search_devicerequest()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.text'),
      jsonb_path_query(new, '$.type'),
      jsonb_path_query(new, '$.useContext.codeCodeableConcept'),
      jsonb_path_query(new, '$.identifier'),
      jsonb_path_query(new, '$.subject[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.encounter'),
      jsonb_path_query(new, '$.authoredOn'),
      jsonb_path_query(new, '$.basedOn'),
      jsonb_path_query(new, '$.useContext.codeReference'),
      jsonb_path_query(new, '$.occurrenceDateTime'),
...
create or replace function internal.search_medication()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.identifier'),
      jsonb_path_query(new, '$.ingredient.itemReference'),
      jsonb_path_query(new, '$.ingredient.itemCodeableConcept'),
...
create or replace function internal.search_medicationadministration()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.text'),
      jsonb_path_query(new, '$.type'),
      jsonb_path_query(new, '$.medicationCodeableConcept'),
      jsonb_path_query(new, '$.identifier'),
      jsonb_path_query(new, '$.subject[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.context'),
      jsonb_path_query(new, '$.device'),
      jsonb_path_query(new, '$.effective'),
      jsonb_path_query(new, '$.medicationReference'),
...
create or replace function internal.search_observation()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.component.valueCodeableConcept'),
      jsonb_path_query(new, '$.component.valueQuantity'),
      jsonb_path_query(new, '$.dataAbsentReason'),
...
create or replace function internal.search_encounter()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.participant.individual[*] ? (@.type like ''%Practitioner%'' or @.reference like ''%Practitioner%'')'),
      jsonb_path_query(new, '$.reasonCode'),
      jsonb_path_query(new, '$.reasonReference'),
...
create or replace function internal.search_episodeofcare()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.patient'),
      jsonb_path_query(new, '$.type'),
      jsonb_path_query(new, '$.careManager[*] ? (@.type like ''%Practitioner%'' or @.reference like ''%Practitioner%'')'),
      jsonb_path_query(new, '$.diagnosis.condition'),
...
create or replace function internal.search_documentreference()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.subject[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.type'),
      jsonb_path_query(new, '$.context.encounter[*] ? (@.type like ''%Encounter%'' or @.reference like ''%Encounter%'')'),
...
create or replace function internal.search_appointment()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.identifier'),
      jsonb_path_query(new, '$.participant.actor[*] ? (@.type like ''%Location%'' or @.reference like ''%Location%'')'),
      jsonb_path_query(new, '$.participant.status'),
      jsonb_path_query(new, '$.participant.actor[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.participant.actor[*] ? (@.type like ''%Practitioner%'' or @.reference like ''%Practitioner%'')'),
      jsonb_path_query(new, '$.reasonCode'),
      jsonb_path_query(new, '$.reasonReference'),
...
create or replace function internal.search_appointmentresponse()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.appointment'),
      jsonb_path_query(new, '$.identifier'),
      jsonb_path_query(new, '$.actor[*] ? (@.type like ''%Location%'' or @.reference like ''%Location%'')'),
      jsonb_path_query(new, '$.participantStatus'),
      jsonb_path_query(new, '$.actor[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.actor[*] ? (@.type like ''%Practitioner%'' or @.reference like ''%Practitioner%'')')
    );
  return new;
  end;
$$ language plpgsql security definer;
...
create or replace function internal.search_auditevent()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.agent.who[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
...
create or replace function internal.search_clinicalusedefinition()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.subject[*] ? (@.type like ''%MedicinalProductDefinition%'' or @.reference like ''%MedicinalProductDefinition%'')'),
      jsonb_path_query(new, '$.subject'),
      jsonb_path_query(new, '$.type')
    );
  return new;
...
create or replace function internal.search_organizationaffiliation()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.telecom[*] ? (@.system = ''phone'')'),
      jsonb_path_query(new, '$.organization'),
      jsonb_path_query(new, '$.code'),
...
create or replace function internal.search_person()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.name'),
      jsonb_path_query(new, '$.managingOrganization'),
      jsonb_path_query(new, '$.link.target[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.link.target[*] ? (@.type like ''%Practitioner%'' or @.reference like ''%Practitioner%'')'),
      jsonb_path_query(new, '$.link.target[*] ? (@.type like ''%RelatedPerson%'' or @.reference like ''%RelatedPerson%'')')
    );
  return new;
  end;
$$ language plpgsql security definer;
...
create or replace function internal.search_provenance()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.entity.what'),
      jsonb_path_query(new, '$.location'),
      jsonb_path_query(new, '$.target[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.recorded'),
...
create or replace function internal.search_task()
  ...
  begin
    ...
    (
      ...
      jsonb_path_query(new, '$.owner'),
      jsonb_path_query(new, '$.partOf'),
      jsonb_path_query(new, '$.for[*] ? (@.type like ''%Patient%'' or @.reference like ''%Patient%'')'),
      jsonb_path_query(new, '$.performerType'),
