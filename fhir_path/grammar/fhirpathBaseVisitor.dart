...
class fhirpathBaseVisitor<T> extends ParseTreeVisitor<T> implements fhirpathVisitor<T> {
  ...
  /// [visitChildren] on [ctx].
  @override
  T visitPolarityExpression(PolarityExpressionContext ctx) => visitChildren(ctx);
  /// The default implementation returns the result of calling
  /// [visitChildren] on [ctx].
  @override
  ...
  /// [visitChildren] on [ctx].
  @override
  T visitInvocationExpression(InvocationExpressionContext ctx) => visitChildren(ctx);
  /// The default implementation returns the result of calling
  /// [visitChildren] on [ctx].
  @override
