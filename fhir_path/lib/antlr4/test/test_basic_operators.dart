  ...
  group(
    ...
    () {
      ...
      test('!= : ', () {
        expect(
            walkFhirPath(
                context: resource.toJson(), pathExpression: '10 != 10'),
            [false]);
        expect(
            walkFhirPath(context: resource.toJson(), pathExpression: '10 != 9'),
            [true]);
      ...
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: "'string' < 'String'"), [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '10 < 5 // false'), [false]);
      //     expect(
      //         walkFhirPath(context: resource.toJson(), pathExpression:
      //             '10 < 5.0 // false; note the 10 is converted to a decimal to perform the comparison'),
      //         [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: "'abc' < 'ABC' // false"), [false]);
      //     // expect(
      //     //     walkFhirPath(context: resource.toJson(), pathExpression:
      //     //         "4 'm' > 4 'cm' // true (or { } if the implementation does not support unit conversion)"),
      //     //     [true]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@2018-03-01 < @2018-01-01 // false'), [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@2018-03 < @2018-03-01 // empty ({ })'), []);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@2018-03-01T10:30:00 < @2018-03-01T10:00:00 // false'),
      //         [false]);
      ...
      //         [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@T10:30:00 < @T10:00:00 // false'), [false]);
      ...
      //   });
      //   test('<= : >', () {
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@T12:25 <= @T12:25'), [true]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@T12:27 <= @T12:25'), [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: "'String' <= 'String'"), [true]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: "'string' <= 'String'"), [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '10 <= 5 // true'), [false]);
      //     expect(
      //         walkFhirPath(context: resource.toJson(), pathExpression:
      //             '10 <= 5.0 // false; note the 10 is converted to a decimal to perform the comparison'),
      //         [false]);
      ...
      //         [false]);
      //     expect(
      //         walkFhirPath(context: resource.toJson(), pathExpression: '@2018-03-01T10 <= @2018-03-01T10:30 // empty ({ })'), []);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@2018-03-01T10:30:00 <= @2018-03-01T10:30:00.0 // true'),
      //         [true]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@T10:30:00 <= @T10:00:00 // false'), [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@T10 <= @T10:30 // empty ({ })'), []);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@T10:30:00 <= @T10:30:00.0 // true'), [true]);
      //   });
      //   test('>= : ', () {
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '@T12:25 >= @T12:25'), [true]);
      ...
      //             '10 >= 5.0 // false; note the 10 is converted to a decimal to perform the comparison'),
      //         [true]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: "'abc' >= 'ABC' // false"), [true]);
      //     // expect(
      //     //     walkFhirPath(context: resource.toJson(), pathExpression:
      //     //         "4 'm' > 4 'cm' // true (or { } if the implementation does not support unit conversion)"),
      //     //     []);
      ...
      //   });
      //   test('is : ', () {
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '12 is Integer'), [true]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '12 is Decimal'), [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '12.5 is Integer'), [false]);
      //     expect(walkFhirPath(context: resource.toJson(), pathExpression: '12.5 is Decimal'), [true]);
      //   });
      // });
      // group(
      //   'Math Operators: ',
      //   () {
      //     test('/ : ', () {
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '(1.2 / 1.8).round(8) = 0.66666667'), [true]);
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '1/0'), []);
      //     });
      //     test('- : ', () {
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '75-70'), [5]);
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '75-70-75'), [-70]);
      //     });
      //     test('Precedence : ', () {
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '75+70-75'), [70]);
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '1+2*3+4 = 11'), [true]);
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '1+2*-3+4 = -1'), [true]);
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '-1-2*3 = -7'), [true]);
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '1-2*3-4*5 = -25'), [true]);
      //       expect(walkFhirPath(context: resource.toJson(), pathExpression: '1-2.ceiling()*3-4*5.ceiling() = -25'), [true]);
      //     });
    },
  );
}
