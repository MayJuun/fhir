...
<expression invalid="semantic">name.given1</expression>
    ...
    /// ToDo: generally FHIRPath uses a 0-based index
...
// /*<test name="testLiteralDecimalLessThanInvalid" inputfile="observation-example.xml"><expression invalid="semantic">Observation.value.value < 'test'</expression>// no output - empty set});*/
  ...
  test("testEmpty", () {
    expect(
        walkFhirPath(
            context: patientExample(), pathExpression: r"Patient.link.empty()"),
        [true]);
  });
  ...
  test("testNotInvalid", () {
    expect(
        () => walkFhirPath(
            context: patientExample(), pathExpression: r"(1|2).not() = false"),
...
// // TODO: Incorrect test case. Wrong assumptions around precedence
  ...
  test("testBooleanLiteralToInteger", () {
    expect(
        walkFhirPath(
            context: patientExample(), pathExpression: r"true.toInteger() = 1"),
        [true]);
  });
...
// TODO: Incorrect precedence
  ...
  // todo: again, incorrect grouping in example
  ...
  test("testIntegerLiteralToDecimal", () {
    expect(
        walkFhirPath(
            context: patientExample(), pathExpression: r"1.toDecimal() = 1.0"),
        [true]);
  });
  ...
  test("testBooleanLiteralToDecimal", () {
    expect(
        walkFhirPath(
            context: patientExample(), pathExpression: r"true.toDecimal() = 1"),
        [true]);
  });
...
/*<test name="testIntegerLiteralToBooleanEmpty" inputfile="patient-example.xml"><expression>2.toBoolean()</expression>// empty});*/
  ...
  test("testStringFalseToBoolean", () {
    expect(
        walkFhirPath(
            context: patientExample(), pathExpression: r"'false'.toBoolean()"),
        [false]);
  });
...
/*    test("testSuperSetOf1", () {
    ...
    test("testSuperSetOf2", () {
      expect(
          walkFhirPath(
              context: patientExample(), pathExpression: r"Patient.name.supersetOf($this.name.first())"),
          [true]);
    }); */
...
/*      test("testFirstLast2", () {
      ...
      group('testTail', () {
        // TODO: Incorrect test case. Union operator does specifically not guarantee an order
/*      test("testTail1", () {
        expect(walkFhirPath(context: patientExample(), pathExpression: r"(0 | 1 | 2).tail() = 1 | 2"),
            [true]);
      }); */
/*      test("testTail2", () {
        // TODO: Incorrect test case. Union operator does specifically not guarantee an order
        expect(
            walkFhirPath(context: patientExample(), pathExpression: r"Patient.name.tail().given = 'Jim' | 'Peter' | 'James'"),
            [true]);
      }); */
...
/*      test("testSkip1", () {
        expect(walkFhirPath(context: patientExample(), pathExpression: r"(0 | 1 | 2).skip(1) = 1 | 2"),
            [true]);
      }); */
        // TODO: Incorrect test case. Assumes order of union
/*      test("testSkip2", () {
        expect(
            walkFhirPath(context: patientExample(), pathExpression: r"(0 | 1 | 2).skip(2) = 2"), [true]);
      }); */
        // TODO: Incorrect test case. Assumes order of union
/*      test("testSkip3", () {
        expect(
...
/*      test("testTake1", () {
        expect(
            walkFhirPath(context: patientExample(), pathExpression: r"(0 | 1 | 2).take(1) = 0"), [true]);
      }); */
        // TODO: Incorrect test case. Assumes order of union
/*      test("testTake2", () {
        expect(walkFhirPath(context: patientExample(), pathExpression: r"(0 | 1 | 2).take(2) = 0 | 1"),
            [true]);
      }); */
        // TODO: Incorrect test case. Assumes order of union
/*      test("testTake3", () {
        expect(
            walkFhirPath(context: patientExample(), pathExpression: r"Patient.name.take(1).given = 'Peter' | 'James'"),
            [true]);
      }); */
...
/*      test("testTake4", () {
        expect(
            walkFhirPath(context: patientExample(), pathExpression: r"Patient.name.take(2).given = 'Peter' | 'James' | 'Jim'"),
            [true]);
      }); */
...
/*      test("testToChars1", () {
        expect(walkFhirPath(context: patientExample(), pathExpression: r"'t2'.toChars() = 't' | '2'"),
            [true]);
      }); */
      ...
      group('testNow', () {
        // again, matching now() (DateTime) against birthDate (which is only
      ...
      group('testEquality', () {
        ...
        test("testEquality2", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: "{} = {}"),
              []);
        });
        test("testEquality3", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: "true = {}"),
              []);
        });
        test("testEquality4", () {
          expect(
...
/*      test("testEquality7", () {
        ...
        test("testEquality15", () {
          expect(
              walkFhirPath(context: patientExample(), pathExpression: r"0 = 0"),
              [true]);
        });
        test("testEquality16", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"0.0 = 0"),
              [true]);
        });
        test("testEquality17", () {
          expect(
...
/*test("testEquality19", () {expect(walkFhirPath(context: patientExample(), "@2012-04-15 = @2012-04-15T10:00:00"), []);});*/
        test("testEquality20", () {
          expect(
              walkFhirPath(
                  context: patientExample(),
...
/*test("testEquality23", () {expect(walkFhirPath(context: patientExample(), "@2012-04-15T15:00:00Z = @2012-04-15T10:00:00"), []);});*/
        test("testEquality24", () {
          expect(
              walkFhirPath(
                  context: patientExample(),
...
/*      test("testEquality27", () {
      ...
      group('testNEquality', () {
        ...
        test("testNEquality3", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"1 != 2"),
              [true]);
        });
        test("testNEquality4", () {
          expect(
        ...
        test("testNEquality9", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"0 != 0"),
              [false]);
        });
        ...
        // todo: decide if we should continue to include a default timezone
      ...
      group('testEquivalent', () {
        ...
        test("testEquivalent2", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"{} ~ {}"),
              [true]);
        });
        test("testEquivalent3", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"1 ~ {}"),
              [false]);
        });
        ...
        // todo: correct equivalence parser to compare numbers using significant
        // digits
      ...
      group('testLessThan', () {
        ...
        test("testLessThan15", () {
          expect(
              walkFhirPath(context: patientExample(), pathExpression: r"2 < 1"),
              [false]);
        });
        test("testLessThan16", () {
          expect(
      ...
      group('testLessOrEqual', () {
        ...
        test("testLessOrEqual15", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"2 <= 1"),
              [false]);
        });
      ...
      group('testPlus', () {
        test("testPlus1", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"1 + 1 = 2"),
              [true]);
        });
        test("testPlus2", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"1 + 0 = 1"),
              [true]);
        });
        test("testPlus3", () {
          expect(
      ...
      group('testMinus', () {
        test("testMinus1", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"1 - 1 = 0"),
              [true]);
        });
        test("testMinus2", () {
          expect(
...
/*      test("testMinus3", () {
      ...
      group('testMultiply', () {
        test("testMultiply1", () {
          expect(
              walkFhirPath(
                  context: patientExample(),
                  pathExpression: r"1.2 * 1.8 = 2.16"),
              [true]);
        });
        test("testMultiply2", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"1 * 1 = 1"),
              [true]);
        });
        test("testMultiply3", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"1 * 0 = 0"),
              [true]);
        });
      });
      ...
      group('testDivide', () {
        ...
        test("testDivide2", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: r"4 / 2 = 2"),
              [true]);
        });
        test("testDivide3", () {
          expect(
      ...
      group('testDiv', () {
        ...
        test("testDiv4", () {
          expect(
              walkFhirPath(
                  context: patientExample(),
                  pathExpression: r"2.2 div 1.8 = 1"),
              [true]);
        });
        test("testDiv5", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: "5 div 0"),
              []);
        });
      });
...
/*      test("testMod4", () {
        ...
        test("testMod5", () {
          expect(
              walkFhirPath(
                  context: patientExample(), pathExpression: "5 mod 0"),
              []);
        });
      });
      ...
      group('testCeiling', () {
        ...
        test("testCeiling3", () {
          expect(
              walkFhirPath(
                  context: patientExample(),
                  pathExpression: r"1.1.ceiling() = 2"),
              [true]);
        });
      });
...
/*      test("testPrecedence3", () {
        ...
        test("testPrecedence3-fixed", () {
          () => expect(
              walkFhirPath(
                  context: patientExample(),
                  pathExpression: r"1 > 2 is Boolean"),
              throwsA(TypeMatcher<FhirPathEvaluationException>()));
        });
        // TODO: Incorrect test case. 'is' has higher precedence than |
/*      test("testPrecedence4", () {
      ...
      group('testType', () {
        ...
        //       walkFhirPath(
        //           context: patientExample(),
        //           pathExpression: r"true is Boolean"),
        //       [true]);
        // });
        // test("testType6", () {
        //   expect(
...
/*      test("testType14", () {
        ...
        test("testType17", () {
          expect(
              walkFhirPath(
                  context: patientExample(),
                  pathExpression: r"Patient is Patient"),
              [true]);
        });
        // test("testType18", () {
        //   expect(
