...
/*test("testSimpleWithContext", () {expect(walkFhirPath(context: patientExample(), pathExpression: r"Patient.name.given"), ["Peter"]);});
<output type="string">James</output>
<output type="string">Jim</output>
<output type="string">Peter</output>
<output type="string">James</output>
...
/*  test("testPolymorphismIsB", () {
    expect(
        walkFhirPath(
            context: observationExample(), pathExpression: r"Observation.value is Period.not()"),
        [true]);
  }); */
...
/*  test("testPolymorphismAsA", () {
    expect(
        walkFhirPath(
            context: observationExample(), pathExpression: r"Observation.value.as(Quantity).unit"),
        ["lbs"]);
  }); */
// testBoolean(observation(), "(Observation.value as Quantity).unit", true);
...
/*test("testDecimalLiteralToInteger", () {expect(walkFhirPath(context: patientExample(), "'1.1'.toInteger() = {}"), []);});*/
...
/*      test("testDivide5", () {
      ...
      test("testDivide6", () {
        expect(walkFhirPath(context: patientExample(), pathExpression: "1 / 0"),
            []);
      });
    });
    ...
    group('testDiv', () {
      ...
      test("testDiv5", () {
        expect(
            walkFhirPath(context: patientExample(), pathExpression: "5 div 0"),
            []);
      });
    });
...
/*      test("testMod4", () {
      ...
      test("testMod5", () {
        expect(
            walkFhirPath(context: patientExample(), pathExpression: "5 mod 0"),
            []);
      });
    });
