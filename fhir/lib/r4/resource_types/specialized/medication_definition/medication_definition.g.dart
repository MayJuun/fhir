...
_$_MedicinalProduct _$_$_MedicinalProductFromJson(Map<String, dynamic> json) {
  return _$_MedicinalProduct(
    resourceType: _$enumDecode(_$R4ResourceTypeEnumMap, json['resourceType'],
...
_$_MedicinalProductName _$_$_MedicinalProductNameFromJson(
  ...
  return _$_MedicinalProductName(
    ...
    namePart: (json['namePart'] as List<dynamic>?)
        ?.map(
            (e) => MedicinalProductNamePart.fromJson(e as Map<String, dynamic>))
        .toList(),
    countryLanguage: (json['countryLanguage'] as List<dynamic>?)
        ?.map((e) =>
            MedicinalProductCountryLanguage.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}
...
_$_MedicinalProductManufacturingBusinessOperation
  ...
  return _$_MedicinalProductManufacturingBusinessOperation(
    ...
    effectiveDateElement: json['_effectiveDate'] == null
        ? null
        : Element.fromJson(json['_effectiveDate'] as Map<String, dynamic>),
...
_$_MedicinalProductContraindication
  ...
  return _$_MedicinalProductContraindication(
    resourceType: _$enumDecode(_$R4ResourceTypeEnumMap, json['resourceType'],
        unknownValue: R4ResourceType.MedicinalProductContraindication),
    id: json['id'] == null ? null : Id.fromJson(json['id']),
    meta: json['meta'] == null
        ? null
        : Meta.fromJson(json['meta'] as Map<String, dynamic>),
...
_$_MedicinalProductPharmaceuticalTargetSpecies
  ...
  return _$_MedicinalProductPharmaceuticalTargetSpecies(
    ...
    withdrawalPeriod: (json['withdrawalPeriod'] as List<dynamic>?)
        ?.map((e) => MedicinalProductPharmaceuticalWithdrawalPeriod.fromJson(
            e as Map<String, dynamic>))
        .toList(),
  );
}
...
_$_MedicinalProductUndesirableEffect
  ...
  return _$_MedicinalProductUndesirableEffect(
    resourceType: _$enumDecode(_$R4ResourceTypeEnumMap, json['resourceType'],
        unknownValue: R4ResourceType.MedicinalProductUndesirableEffect),
    id: json['id'] == null ? null : Id.fromJson(json['id']),
    meta: json['meta'] == null
        ? null
        : Meta.fromJson(json['meta'] as Map<String, dynamic>),
...
_$_SubstancePolymer _$_$_SubstancePolymerFromJson(Map<String, dynamic> json) {
  return _$_SubstancePolymer(
    ...
    repeat: (json['repeat'] as List<dynamic>?)
        ?.map((e) => SubstancePolymerRepeat.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}
...
_$_SubstanceProtein _$_$_SubstanceProteinFromJson(Map<String, dynamic> json) {
  return _$_SubstanceProtein(
    ...
    subunit: (json['subunit'] as List<dynamic>?)
        ?.map(
            (e) => SubstanceProteinSubunit.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}
...
_$_SubstanceSpecification _$_$_SubstanceSpecificationFromJson(
  ...
  return _$_SubstanceSpecification(
    ...
    property: (json['property'] as List<dynamic>?)
        ?.map((e) =>
            SubstanceSpecificationProperty.fromJson(e as Map<String, dynamic>))
        .toList(),
...
_$_SubstanceSpecificationName _$_$_SubstanceSpecificationNameFromJson(
  ...
  return _$_SubstanceSpecificationName(
    ...
    official: (json['official'] as List<dynamic>?)
        ?.map((e) =>
            SubstanceSpecificationOfficial.fromJson(e as Map<String, dynamic>))
        .toList(),
    source: (json['source'] as List<dynamic>?)
        ?.map((e) => Reference.fromJson(e as Map<String, dynamic>))
        .toList(),
