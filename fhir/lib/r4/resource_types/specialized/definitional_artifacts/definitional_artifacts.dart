...
class DeviceDefinitionSpecialization with _$DeviceDefinitionSpecialization {
  ...
  /// Factory constructor, accepts [Map<String, dynamic>] as an argument
  factory DeviceDefinitionSpecialization.fromJson(Map<String, dynamic> json, SerializationManager serializationManager,) =>
...
class DeviceDefinitionCapability with _$DeviceDefinitionCapability {
  ...
  /// Factory constructor, accepts [Map<String, dynamic>] as an argument
  factory DeviceDefinitionCapability.fromJson(Map<String, dynamic> json, SerializationManager serializationManager,) =>
