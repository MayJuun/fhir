...
final codeFromImmunizationStatus = {
  ImmunizationStatus.completed: Code('completed'),
  ImmunizationStatus.entered_in_error: Code('entered-in-error'),
  ImmunizationStatus.not_done: Code('not-done'),
};
