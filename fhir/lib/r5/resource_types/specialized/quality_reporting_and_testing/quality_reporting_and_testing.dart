...
@freezed
class TestPlanDependency with _$TestPlanDependency {
  /// [TestPlanDependency] A plan for executing testing on an artifact or specifications.
  TestPlanDependency._();
...
@freezed
class TestPlanTestCase with _$TestPlanTestCase {
  /// [TestPlanTestCase] A plan for executing testing on an artifact or specifications.
  TestPlanTestCase._();
...
@freezed
class TestPlanDependency1 with _$TestPlanDependency1 {
  /// [TestPlanDependency1] A plan for executing testing on an artifact or specifications.
  TestPlanDependency1._();
...
@freezed
class TestPlanTestRun with _$TestPlanTestRun {
  /// [TestPlanTestRun] A plan for executing testing on an artifact or specifications.
  TestPlanTestRun._();
...
@freezed
class TestPlanScript with _$TestPlanScript {
  /// [TestPlanScript] A plan for executing testing on an artifact or specifications.
  TestPlanScript._();
...
@freezed
class TestPlanTestData with _$TestPlanTestData {
  /// [TestPlanTestData] A plan for executing testing on an artifact or specifications.
  TestPlanTestData._();
...
@freezed
class TestPlanAssertion with _$TestPlanAssertion {
  /// [TestPlanAssertion] A plan for executing testing on an artifact or specifications.
  TestPlanAssertion._();
...
@freezed
class TestReportRequirement with _$TestReportRequirement {
  /// [TestReportRequirement] A summary of information based on the results of executing a TestScript.
  TestReportRequirement._();
  ...
  /// [modifierExtension] May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions.Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
  ///
  /// [linkUri] Link or reference providing traceability to the testing requirement for this test.
  ///
  /// [linkUriElement] ("_linkUri") Extensions for linkUri
  ///
  /// [linkCanonical] Link or reference providing traceability to the testing requirement for this test.
  ///
...
@freezed
class TestScriptRequirement with _$TestScriptRequirement {
  /// [TestScriptRequirement] A structured set of tests against a FHIR server or client implementation to determine compliance against the FHIR specification.
  TestScriptRequirement._();
