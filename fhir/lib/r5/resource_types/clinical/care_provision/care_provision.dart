...
class RequestOrchestrationDynamicValue with _$RequestOrchestrationDynamicValue {
  ...
  /// Acts like a constructor, returns a [RequestOrchestrationDynamicValue], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
class ServiceRequestPatientInstruction with _$ServiceRequestPatientInstruction {
  ...
  ///
  /// [instructionMarkdownElement] ("_instructionMarkdown") Extensions for instructionMarkdown
  ///
  ...
  /// Acts like a constructor, returns a [ServiceRequestPatientInstruction], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
