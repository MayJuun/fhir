...
/// [GenomicStudy] A Genomic Study is a set of analysis performed to analyze and generate genomic data.
@freezed
...
/// [GenomicStudyAnalysis] A Genomic Study is a set of analysis performed to analyze and generate genomic data.
@freezed
...
/// [GenomicStudyInput] A Genomic Study is a set of analysis performed to analyze and generate genomic data.
@freezed
...
/// [GenomicStudyOutput] A Genomic Study is a set of analysis performed to analyze and generate genomic data.
@freezed
...
/// [GenomicStudyPerformer] A Genomic Study is a set of analysis performed to analyze and generate genomic data.
@freezed
...
/// [GenomicStudyDevice] A Genomic Study is a set of analysis performed to analyze and generate genomic data.
@freezed
...
/// [ImagingSelectionImageRegion1] A selection of DICOM SOP instances and/or frames within a single Study and Series. This might include additional specifics such as an image region, an Observation UID or a Segmentation Number, allowing linkage to an Observation Resource or transferring this information along with the ImagingStudy Resource.
@freezed
class ImagingSelectionImageRegion1 with _$ImagingSelectionImageRegion1 {
  ...
  /// Acts like a constructor, returns a [ImagingSelectionImageRegion1], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
