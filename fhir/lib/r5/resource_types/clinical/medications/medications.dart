...
class ImmunizationProgramEligibility with _$ImmunizationProgramEligibility {
  ...
  /// Acts like a constructor, returns a [ImmunizationProgramEligibility], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
class MedicationRequest with Resource, _$MedicationRequest {
  ...
  ///
  /// [category] An arbitrary categorization or grouping of the medication request.  It could be used for indicating where meds are intended to be administered, eg. in an inpatient setting or in a patient's home, or a legal category of the medication.
  ///
  ...
  ///
  /// [subject] The individual or group for whom the medication has been requested.
  ///
...
class MedicationStatementAdherence with _$MedicationStatementAdherence {
  ...
  /// Acts like a constructor, returns a [MedicationStatementAdherence], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
