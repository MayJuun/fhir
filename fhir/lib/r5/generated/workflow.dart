...
import 'package:freezed_annotation/freezed_annotation.dart';
  ...
  class Appointment with Resource,  _Appointment {
  Appointment._();
...
The duration (usually in minutes) could also be provided to indicate the length of the appointment to fill and populate the start/end times for the actual allocated time. However, in other situations the duration may be calculated by the scheduling system.;
  factory Appointment({
resourceType = const R5ResourceType.Appointment R5ResourceType,
   Id? id,
   Meta? meta,
   Uri? implicitRules,
...
'
  ...
  class AppointmentParticipant with  _AppointmentParticipant {
...
@JsonKey(name: '_status')   Element? statusElement,
  ...
  /// Acts like a constructor, returns a [Appointment_Participant], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
'
  ...
  class AppointmentResponse with Resource,  _AppointmentResponse {
...
resourceType = const R5ResourceType.AppointmentResponse R5ResourceType,
   Id? id,
   Meta? meta,
   Uri? implicitRules,
@JsonKey(name: '_implicitRules')   Element? implicitRulesElement,
...
'
  ...
  class Schedule with Resource,  _Schedule {
  Schedule._();
...
/// [commentElement] (_comment): Extensions for comment;
  factory Schedule({
resourceType = const R5ResourceType.Schedule R5ResourceType,
   Id? id,
   Meta? meta,
   Uri? implicitRules,
@JsonKey(name: '_implicitRules')   Element? implicitRulesElement,
...
'
  ...
  class Slot with Resource,  _Slot {
  Slot._();
...
/// [commentElement] (_comment): Extensions for comment;
  factory Slot({
resourceType = const R5ResourceType.Slot R5ResourceType,
   Id? id,
   Meta? meta,
   Uri? implicitRules,
@JsonKey(name: '_implicitRules')   Element? implicitRulesElement,
...
'
  ...
  class Task with Resource,  _Task {
  Task._();
...
/// [output]: Outputs produced by the Task.;
  factory Task({
resourceType = const R5ResourceType.Task R5ResourceType,
   Id? id,
   Meta? meta,
   Uri? implicitRules,
@JsonKey(name: '_implicitRules')   Element? implicitRulesElement,
...
'
  ...
  class TaskRestriction with  _TaskRestriction {
  TaskRestriction._();
...
@JsonKey(name: '_repetitions')   Element? repetitionsElement,
  ...
  /// Acts like a constructor, returns a [Task_Restriction], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
'
  ...
  class TaskInput with  _TaskInput {
  TaskInput._();
...
@JsonKey(name: '_valueUuid')   Element? valueUuidElement,
  ...
  /// Acts like a constructor, returns a [Task_Input], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
'
  ...
  class TaskOutput with  _TaskOutput {
  TaskOutput._();
...
@JsonKey(name: '_valueUuid')   Element? valueUuidElement,
  ...
  /// Acts like a constructor, returns a [Task_Output], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
'
  ...
  class VerificationResult with Resource,  _VerificationResult {
...
resourceType = const R5ResourceType.VerificationResult R5ResourceType,
   Id? id,
   Meta? meta,
   Uri? implicitRules,
@JsonKey(name: '_implicitRules')   Element? implicitRulesElement,
...
'
  ...
  class VerificationResultPrimarySource with  _VerificationResultPrimarySource {
...
@JsonKey(name: '_validationDate')   Element? validationDateElement,
  ...
  /// Acts like a constructor, returns a [VerificationResult_PrimarySource], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
'
  ...
  class VerificationResultAttestation with  _VerificationResultAttestation {
...
@JsonKey(name: '_proxyIdentityCertificate')   Element? proxyIdentityCertificateElement,
  ...
  }) = _$VerificationResultAttestation;
  ...
  /// Acts like a constructor, returns a [VerificationResult_Attestation], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
...
'
  ...
  class VerificationResultValidator with  _VerificationResultValidator {
...
@JsonKey(name: '_identityCertificate')   Element? identityCertificateElement,
  ...
  /// Acts like a constructor, returns a [VerificationResult_Validator], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
