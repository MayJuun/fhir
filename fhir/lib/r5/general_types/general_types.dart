...
class Identifier with _$Identifier {
  ...
  ///
  /// [system] Establishes the namespace for the value - that is, a absolute URL that describes a set values that are unique.
  ///
...
class SampledData with _$SampledData {
  ...
  ///
  /// [interval] Amount of intervalUnits between samples, eg. milliseconds for time-based sampling.
  ///
...
/// [HumanName] A name, normally of a human, that can be used for other living entities (eg. animals but not organizations) that have been assigned names by a human and may need the use of name parts or the need for usage information.
@freezed
