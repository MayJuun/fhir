const oauthUris = {
  ...
  "abstract": false,
  "context": [
    {"type": "element", "expression": "CapabilityStatement.rest.security"}
  ],
  "type": "Extension",
  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "definition":
            "The OAuth2 dynamic registration endpoint for this FHIR server, if supported.",
        "min": 0,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "definition":
            "The user-facing authorization management workflow entry point for this FHIR server.",
        "min": 0,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
