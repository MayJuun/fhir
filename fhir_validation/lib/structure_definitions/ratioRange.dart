    ...
    "element": [
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "RatioRange", "min": 0, "max": "*"},
        "condition": ["ele-1"],
        "constraint": [
          {
            "key": "ele-1",
        ...
        "mapping": [
          ...
          },
          {
            "identity": "rim",
            "map":
                "IVL<RTO<QTY[not(type=\"TS\")]>> [lowClosed=\"true\" and highClosed=\"true\"]or URG<<RTO<QTY[not(type=\"TS\")]>>"
          }
        ]
      },
      {
