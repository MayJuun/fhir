const cdshooksrequestgroup = {
  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "min": 1,
        "max": "1",
        "base": {"path": "RequestGroup.identifier", "min": 0, "max": "*"},
        "type": [
          {"code": "Identifier"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "RequestGroup.basedOn", "min": 0, "max": "*"},
        "type": [
          {
            "code": "Reference",
            "targetProfile": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "RequestGroup.groupIdentifier", "min": 0, "max": "1"},
        "type": [
          {"code": "Identifier"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "RequestGroup.code", "min": 0, "max": "1"},
        "type": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "RequestGroup.encounter", "min": 0, "max": "1"},
        "type": [
          {
            "code": "Reference",
            "targetProfile": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "RequestGroup.author", "min": 0, "max": "1"},
        "type": [
          {
            "code": "Reference",
            "targetProfile": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "RequestGroup.reasonReference", "min": 0, "max": "*"},
        "type": [
          {
            "code": "Reference",
            "targetProfile": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "RequestGroup.action.code", "min": 0, "max": "*"},
        "type": [
          {"code": "CodeableConcept"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "RequestGroup.action.resource", "min": 0, "max": "1"},
        "type": [
          {
            "code": "Reference",
            "targetProfile": [
      ...
      },
      {
        ...
        "contentReference":
            "http://hl7.org/fhir/StructureDefinition/RequestGroup#RequestGroup.action",
        "condition": ["rqg-1"],
        "constraint": [
          {
            "key": "ele-1",
  ...
  "differential": {
    "element": [
      {"id": "RequestGroup", "path": "RequestGroup", "min": 1, "max": "1"},
      {
        "id": "RequestGroup.identifier",
        "path": "RequestGroup.identifier",
        "min": 1,
      ...
      {"id": "RequestGroup.action", "path": "RequestGroup.action"},
      {
        "id": "RequestGroup.action.title",
        "path": "RequestGroup.action.title",
        "mustSupport": true
