const simpleQuantity = {
  ...
  "text": {
    "status": "generated",
    "div":
        "<div xmlns=\"http://www.w3.org/1999/xhtml\"><h2>Data type SimpleQuantity</h2><p>A fixed quantity (no comparator)</p><h3>Rule</h3><p>The comparator is not used on a SimpleQuantity</p><p>XPath:</p><blockquote><pre>not(exists(f:comparator))</pre></blockquote></div>"
  },
  "extension": [
    {
      "url":
