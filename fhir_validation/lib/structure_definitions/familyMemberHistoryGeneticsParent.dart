const familyMemberHistoryGeneticsParent = {
  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "definition":
            "Distinguishes between different types of parental relationships with varying granularity to support capturing the relationship \"to the degree known\".",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "binding": {
          "extension": [
            {
              ...
              "valueString": "Parental relationship types."
            },
            {
              "url":
          ...
          "valueSet": "http://hl7.org/fhir/ValueSet/parent-relationship-codes"
        },
        "mapping": [
          {"identity": "rim", "map": "N/A"}
        ]
      },
      {
        ...
        "definition":
            "Points to the FamilyMemberHistory record of the relation who is the parent of this relation.",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
