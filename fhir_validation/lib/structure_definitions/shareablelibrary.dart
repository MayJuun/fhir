const shareablelibrary = {
  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Library.identifier", "min": 0, "max": "*"},
        "type": [
          {"code": "Identifier"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Library.contact", "min": 0, "max": "*"},
        "type": [
          {"code": "ContactDetail"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Library.useContext", "min": 0, "max": "*"},
        "type": [
          {"code": "UsageContext"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "Library.effectivePeriod", "min": 0, "max": "1"},
        "type": [
          {"code": "Period"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Library.author", "min": 0, "max": "*"},
        "type": [
          {"code": "ContactDetail"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Library.reviewer", "min": 0, "max": "*"},
        "type": [
          {"code": "ContactDetail"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Library.relatedArtifact", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Library.dataRequirement", "min": 0, "max": "*"},
        "type": [
  ...
  "differential": {
    "element": [
      {"id": "Library", "path": "Library", "min": 1, "max": "1"},
      {
        "id": "Library.url",
        "path": "Library.url",
        "min": 1,
      ...
      {"id": "Library.contact", "path": "Library.contact", "mustSupport": true},
      {
        "id": "Library.description",
        "path": "Library.description",
        "alias": ["scope"],
