const communicationrequestInitiatingLocation = {
    ...
    "element": [
      {
        ...
        "definition":
            "Location where the information being requested to be communicated happened.",
        "comment":
            "Use when the location of initiation is important for interpretation of the communication.  Do not use for general Provenance purposes.",
        "min": 0,
        "max": "1",
