    ...
    "element": [
      {
        ...
        "comment":
            "This is generally only used for \"exception\" statuses such as \"not-done\", \"suspended\" or \"cancelled\".  The reason for performing the event at all is captured in reasonCode, not here.\r(distinct reason codes for different statuses can be enforced using invariants if they are universal bindings).",
        "min": 0,
        "max": "1",
          ...
          "extension": [
            {
              ...
              "valueString":
                  "Codes identifying the reason for the current state of an event."
            },
            {
              "url":
