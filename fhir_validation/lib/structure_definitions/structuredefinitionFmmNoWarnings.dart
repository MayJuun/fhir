const structuredefinitionFmmNoWarnings = {
    ...
    "element": [
      {
        ...
        "definition":
            "The FMM level that would be assigned to the artifact if it had no warnings.",
        "comment":
            "If an artifact is higher than level 0, it must have no warnings from the resource/profile validator. This is the logical level that will apply once warnings have been resolved.",
        "min": 0,
        "max": "1",
