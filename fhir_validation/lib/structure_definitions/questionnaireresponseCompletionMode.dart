const questionnaireresponseCompletionMode = {
    ...
    "element": [
      ...
      },
      {
        ...
        "binding": {
          "extension": [
            {
              ...
              "valueString":
                  "Codes indicating how the questionnaire was completed."
            },
            {
              "url":
          ...
          "description":
              "Codes indicating how the questionnaire was completed.",
          "valueSet": "http://hl7.org/fhir/ValueSet/questionnaireresponse-mode"
        },
        "mapping": [
          {"identity": "rim", "map": "N/A"}
        ]
