const diagnosticReportGeneticsReferences = {
  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "definition":
            "A code that classifies the type of genetic reference link.",
        "min": 0,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "binding": {
          "extension": [
            {
              ...
              "valueString": "Codes for diagnostic genetic reference types."
            },
            {
              "url":
          ...
          "strength": "example",
          "description":
              "Codes based on Snomed for diagnostic genetic reference types",
