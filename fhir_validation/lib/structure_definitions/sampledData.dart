    ...
    "element": [
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "SampledData", "min": 0, "max": "*"},
        "condition": ["ele-1"],
        "constraint": [
          {
            "key": "ele-1",
        ...
        "mapping": [
          ...
          {"identity": "v2", "map": "N/A (but see section 7.14 in v2.7)"},
          {"identity": "rim", "map": "SLIST + GLIST"}
        ]
      },
      {
        "id": "SampledData.id",
      ...
      },
      {
        ...
        "isSummary": true,
        "mapping": [
          {"identity": "rim", "map": "N/A (fixed to 1)"}
        ]
      },
      {
        "id": "SampledData.data",
