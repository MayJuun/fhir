const observationFocusCode = {
  ...
  "contact": [
    {
      "telecom": [
        {"system": "url", "value": "http://hl7.org/special/committees/orders"}
      ]
    }
  ],
  "description":
    ...
    "element": [
      ...
      },
      {
        ...
        "binding": {
          "extension": [
            {
              ...
              "valueString":
                  "Codes for observation targets.  Derived from both HL7 v3 and SNOMED CT code systems."
            },
            {
              "url":
          ...
          "strength": "example",
          "description": "Derived from both HL7 v3 and SNOMED CT code systems",
