    ...
    "element": [
      {
        ...
        "mapping": [
          ...
          {"identity": "workflow", "map": "Event"},
          {
            "identity": "v2",
            "map":
                "Partial mapping from messages containing the AL1 or IAM segment, such as the ADT^A01, ADT^A08, and ADT^A60."
          },
          {
            "identity": "rim",
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "DetectedIssue.identifier", "min": 0, "max": "*"},
        "type": [
          {"code": "Identifier"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "v2", "map": "AL1-4/ IAR-2"},
          {
            "identity": "rim",
            "map":
                ".inboundRelationship[typeCode=SUBJ].source[classCode=OBS, moodCode=EVN, code=SEV].value"
          }
        ]
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "DetectedIssue.patient", "min": 0, "max": "1"},
        "type": [
          {
            "code": "Reference",
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "DetectedIssue.author", "min": 0, "max": "1"},
        "type": [
          {
            "code": "Reference",
            "targetProfile": [
      ...
      },
      {
        ...
        "mapping": [
          {"identity": "workflow", "map": "Event.reasonReference"},
          {
            "identity": "rim",
            "map":
                ".outboundRelationship[typeCode=SUBJ].target[moodCode=EVN, INT]"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "DetectedIssue.evidence.code", "min": 0, "max": "*"},
        "type": [
          {"code": "CodeableConcept"}
        ],
        "constraint": [
        ...
        "mapping": [
          {
            "identity": "rim",
            "map":
                ".outboundRelationship[typeCode=INST].target[classCode=ALRT, moodCode=DEFN].text.uri"
          }
        ]
      },
      {
        ...
        "mapping": [
          {
            "identity": "rim",
            "map":
                ".outboundRelationship[typeCode=MITG].target[classCode=ACT, moodCode=EVN]"
          }
        ]
      },
      {
