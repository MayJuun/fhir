  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "Medication.identifier", "min": 0, "max": "*"},
        "type": [
          {"code": "Identifier"}
        ],
        "constraint": [
        ...
        "mapping": [
          {
            "identity": "script10.6",
            "map":
                "coding.code = //element(*,MedicationType)/DrugCoded/ProductCode\r\rcoding.system = //element(*,MedicationType)/DrugCoded/ProductCodeQualifier\r\rcoding.display = //element(*,MedicationType)/DrugDescription"
          },
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "Medication.manufacturer", "min": 0, "max": "1"},
        "type": [
          {
            "code": "Reference",
            "targetProfile": [
        ...
        "mapping": [
          {
            "identity": "script10.6",
            "map":
                "coding.code =  //element(*,DrugCodedType)/FormCode\r\rcoding.system = //element(*,DrugCodedType)/FormSourceCode"
          },
          {
            "identity": "v2",
            "map":
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "Medication.amount", "min": 0, "max": "1"},
        "type": [
          {"code": "Ratio"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "isSummary": false,
        "mapping": [
          {"identity": "rim", "map": ".scopesRole[typeCode=INGR]"}
        ]
      },
      {
      ...
      },
      {
        ...
        "min": 1,
        "max": "1",
        "base": {"path": "Medication.ingredient.item[x]", "min": 1, "max": "1"},
        "type": [
          {"code": "CodeableConcept"},
          {
            "code": "Reference",
        ...
        "mapping": [
          ...
          },
          {
            "identity": "v2",
            "map":
                "RXC-2-Component Code  if medication: RXO-1-Requested Give Code / RXE-2-Give Code / RXD-2-Dispense/Give Code / RXG-4-Give Code / RXA-5-Administered Code"
          },
