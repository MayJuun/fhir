const noBinding = {
  ...
  "version": "4.3.0",
  "name": "http://hl7.org/fhir/StructureDefinition/no-binding",
  "status": "draft",
  "experimental": false,
  "date": "2015-02-28",
    ...
    "element": [
      {
        "id": "Extension",
        "path": "Extension",
        "short": "Mark that an element definition shouldn't have a binding",
        "definition":
            "Marks that a particular element definition is one that is not expected/allowed to have a binding, even though it has types that may be bound to value sets.",
        "comment":
      ...
      },
      {
        ...
        "fixedUri": "http://hl7.org/fhir/StructureDefinition/no-binding",
        "isModifier": false,
        "isSummary": false,
        "mapping": [
          {"identity": "rim", "map": "N/A"}
