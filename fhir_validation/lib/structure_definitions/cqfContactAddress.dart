const cqfContactAddress = {
  "resourceType": "StructureDefinition",
  "id": "cqf-contactAddress",
  "extension": [
    {
  ...
  "abstract": false,
  "context": [
    {"type": "element", "expression": "ContactDetail"}
  ],
  "type": "Extension",
    ...
    "element": [
      {
        "id": "Extension",
        "path": "Extension",
        "short": "Contributor address",
        "definition": "The address of the contributor.",
        "min": 0,
        "max": "1",
  ...
  "differential": {
    "element": [
      ...
      {"id": "Extension.extension", "path": "Extension.extension", "max": "0"},
      {
        "id": "Extension.url",
        "path": "Extension.url",
        "fixedUri": "http://hl7.org/fhir/StructureDefinition/cqf-contactAddress"
      },
      {
        "id": "Extension.value[x]",
        "path": "Extension.value[x]",
