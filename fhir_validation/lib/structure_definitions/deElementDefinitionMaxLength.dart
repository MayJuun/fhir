const deElementDefinitionMaxLength = {
  ...
  "description": "Data Element for ElementDefinition.maxLength",
  "purpose":
  ...
  "kind": "logical",
  "abstract": false,
  "type": "ElementDefinition.maxLength",
    ...
    "element": [
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "ElementDefinition.maxLength", "min": 0, "max": "1"},
        "type": [
          {"code": "integer"}
        ],
        "isModifier": false,
        "isSummary": true,
        "mapping": [
          {"identity": "v2", "map": "OMC.12"},
          {"identity": "rim", "map": "N/A (MIF territory)"},
          {"identity": "iso11179", "map": ".domain.maximum_character_quantity"}
        ]
      }
    ]
  }
