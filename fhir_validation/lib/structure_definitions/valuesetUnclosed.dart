const valuesetUnclosed = {
  ...
  "abstract": false,
  "context": [
    {"type": "element", "expression": "ValueSet.expansion"}
  ],
  "type": "Extension",
    ...
    "element": [
      {
        ...
        "definition":
            "Marks that the expansion is  incomplete, and values other than those listed may be valid. This may be used because post-coordinated codes are allowed, and no practical expansion can be produced.",
        "comment":
            "This extension exists to allow for definition and use of value sets that are currently unbounded, including those for which it may always be impractical to set bounds. This can be done to allow additional learning in this space, such as exploring poorly understsood consequences of alternatives.",
        "min": 0,
        "max": "1",
