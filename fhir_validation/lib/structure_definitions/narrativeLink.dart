    ...
    "element": [
      {
        ...
        "definition":
            "A human language representation of the concept (resource/element), as a url that is a reference to a portion of the narrative of a resource ([DomainResource.text](narrative.html)).",
        "comment":
            "It's also possible to link to the resource narrative using the [originalText extension](extension-originaltext.html) which claims that the data is derived from the text provided or linked to.",
        "min": 0,
        "max": "1",
