    ...
    "element": [
      {
        ...
        "definition":
            "if ture, indicates that the concept is deprecated from the value set - that is, it should not be used, and is planned to be withdrawn.",
        "comment":
            "Ths status relates to a concept's inclusion in the value set, and might be different to the underlying status of the concept itself.",
        "min": 0,
        "max": "1",
