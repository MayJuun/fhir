const diagnosticReportGeneticsAnalysis = {
  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "short": "Analysis type",
        "definition":
            "Type of the analysis. E.g. for a drug, what is being analyzed - efficacy, reaction, the drug's effect on the user's metabolism, etc.",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "definition":
            "Interpretation of the sequence's effect on the patient's condition or reaction to a medication.",
        "min": 0,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
