    ...
    "element": [
      {
        ...
        "definition":
            "A reference to a concept map that is relevant for the interpretation of this value set.",
        "comment":
            "One use of this extension is to use it to include a partial concept map inside an expansion, only containing maps for the concepts included in this particular expansion.",
        "min": 0,
        "max": "1",
