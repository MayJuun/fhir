    ...
    "element": [
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "ManufacturedItemDefinition", "min": 0, "max": "*"},
        "constraint": [
          {
            "key": "dom-2",
            "severity": "error",
        ...
        "mapping": [
          ...
          {"identity": "idmp", "map": "Manufactured Item"},
      ...
      {
        "id": "ManufacturedItemDefinition.extension",
      ...
      },
      {
        ...
        "mapping": [
          {
            "identity": "idmp",
            "map": "Manufactured Item.Manufactured Dose Form"
          }
        ]
      },
      {
        ...
        "mapping": [
          {
            "identity": "idmp",
            "map":
                "Manufactured Item.Manufacturer / Establishment (Organisation)"
          }
        ]
      },
      {
        ...
        "mapping": [
          {
            "identity": "idmp",
            "map":
                "Manufactured Item.Ingredient (see also FHIR Ingredient resource)"
          }
        ]
      },
      {
        ...
        "mapping": [
          {
            "identity": "idmp",
            "map": "Manufactured Item.Physical Characteristics"
          }
        ]
      },
      {
        "id": "ManufacturedItemDefinition.property.id",
      ...
      {
        "id": "ManufacturedItemDefinition.property.extension",
