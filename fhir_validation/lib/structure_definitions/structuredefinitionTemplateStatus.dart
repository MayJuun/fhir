const structuredefinitionTemplateStatus = {
    ...
    "element": [
      {
        ...
        "definition":
            "Status code taken from [HL7 template specification](http://www.hl7.org/implement/standards/product_brief.cfm?product_id=377) - allows for alignment with the template DSTU, and has more authoring status codes.",
        "comment":
            "The Profile status has the codes that are relevant to end-users/developers, while this extension has the codes used by profile developers.",
        "min": 0,
        "max": "1",
      ...
      },
      {
        ...
        "binding": {
          ...
          "description":
              "The status indicates the level of maturity of the design and may be used to manage the use of the design.",
          "valueSet": "http://hl7.org/fhir/ValueSet/template-status-code"
        },
        "mapping": [
          {"identity": "rim", "map": "N/A"}
        ]
