const iso21090ENQualifier = {
  ...
  "abstract": false,
  "context": [
    {"type": "element", "expression": "HumanName.family"},
    {"type": "element", "expression": "HumanName.given"},
    {"type": "element", "expression": "HumanName.prefix"},
    {"type": "element", "expression": "HumanName.suffix"}
  ],
  "type": "Extension",
    ...
    "element": [
      {
        ...
        "isModifier": false,
        "mapping": [
          {"identity": "rim", "map": "ENXP.qualifier"}
        ]
      },
      {
        "id": "Extension.id",
      ...
      },
      {
        ...
        "binding": {
          ...
          "strength": "required",
          "valueSet": "http://hl7.org/fhir/ValueSet/name-part-qualifier|4.3.0"
        },
        "mapping": [
          {"identity": "rim", "map": "N/A"}
        ]
