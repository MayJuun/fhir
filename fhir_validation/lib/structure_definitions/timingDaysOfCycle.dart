const timingDaysOfCycle = {
  ...
  "contact": [
    {
      "telecom": [
        {"system": "url", "value": "http://hl7.org/special/committees/MnM"}
      ]
    }
  ],
  "description":
  ...
  "abstract": false,
  "context": [
    {"type": "element", "expression": "PlanDefinition.action"},
    {"type": "element", "expression": "RequestGroup.action"}
  ],
  "type": "Extension",
  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "definition":
            "An integer that specifies a day on which the action is to be performed (starting at one).  In most cases, the first day of the first cycle will be day 1.",
        "min": 1,
        "max": "*",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
