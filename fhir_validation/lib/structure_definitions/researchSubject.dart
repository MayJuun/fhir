  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "ResearchSubject.identifier", "min": 0, "max": "*"},
        "type": [
          {"code": "Identifier"}
        ],
        "constraint": [
        ...
        "mapping": [
          ...
          {"identity": "BRIDG5.1", "map": "StudySubject > Subject.identifier"},
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "ResearchSubject.period", "min": 0, "max": "1"},
        "type": [
          {"code": "Period"}
        ],
        "constraint": [
      ...
      },
      {
        ...
        "min": 1,
        "max": "1",
        "base": {"path": "ResearchSubject.individual", "min": 1, "max": "1"},
        "type": [
          {
            "code": "Reference",
        ...
        "mapping": [
          {
            "identity": "BRIDG5.1",
            "map":
                "Arm > ExperimentalUnit > BiologicEntity > Subject > StudySubject"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "min": 0,
        "max": "1",
        "base": {"path": "ResearchSubject.consent", "min": 0, "max": "1"},
        "type": [
          {
            "code": "Reference",
        ...
        "mapping": [
          {
            "identity": "BRIDG5.1",
            "map":
                "ResearchStudy.consent is related to PerformedStudySubjectMilestone.informedConsentIndicator in that the informedConsentIndicator can be derived from the data in the Consent resource."
          }
        ]
      }
    ]
