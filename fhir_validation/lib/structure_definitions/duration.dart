    ...
    "element": [
      {
        ...
        "constraint": [
          {
            ...
            "expression":
                "value.exists() implies ((system = %ucum) and code.exists())",
            "xpath":
        ...
        "mapping": [
          ...
          {"identity": "rim", "map": "PQ, IVL<PQ> depending on the values"}
        ]
      },
      {
        "id": "Duration.id",
