const deElementDefinitionMappingMap = {
  "resourceType": "StructureDefinition",
  "id": "de-ElementDefinition.mapping.map",
  "meta": {"lastUpdated": "2022-05-28T12:47:40.239+10:00"},
  "url":
      "http://hl7.org/fhir/StructureDefinition/de-ElementDefinition.mapping.map",
  "version": "4.3.0",
  "name": "ElementDefinition.mapping.map",
  "title": "ElementDefinition.mapping.map",
  "status": "draft",
  "experimental": true,
  ...
  "description": "Data Element for ElementDefinition.mapping.map",
  "purpose":
  ...
  "kind": "logical",
  "abstract": false,
  "type": "ElementDefinition.mapping.map",
    ...
    "element": [
      {
        ...
        "min": 1,
        "max": "1",
        "base": {"path": "ElementDefinition.mapping.map", "min": 1, "max": "1"},
        "type": [
          {"code": "string"}
        ],
        "isModifier": false,
