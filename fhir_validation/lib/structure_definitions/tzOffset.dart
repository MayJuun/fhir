    ...
    "element": [
      {
        ...
        "definition":
            "Timezone offset, for dates where timezone is not allowed as part of the base date.",
        "comment":
            "The format must either be 'Z' or +/-HH:NN. This is not allowed on the base date because many implementations have no way to carry a timezone on the base date structure.",
        "min": 0,
        "max": "1",
