    ...
    "element": [
      {
        ...
        "definition":
            "Consumers of the value set and the implementations, projects or standards that the author has utilized the value set in.",
        "comment":
            "This is likely to be a point-in-time view and should not be considered an authoritative listing of all uses of the value set.",
        "min": 0,
        "max": "*",
      ...
      },
      {
        ...
        "definition":
            "This is most likely to be an organization but can be an individual. It would not be a program, that information should be recorded in the usage.use.",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "definition":
            "A descriptive name of the project or standard in which the value set is used.",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
