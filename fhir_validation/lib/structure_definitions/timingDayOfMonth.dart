const timingDayOfMonth = {
  ...
  "abstract": false,
  "context": [
    {"type": "element", "expression": "Timing.repeat"}
  ],
  "type": "Extension",
    ...
    "element": [
      {
        ...
        "definition":
            "When present, this extension indicate that the event actually only occurs on the specified days of the month, on the times as otherwise specified by the timing schedule.",
        "comment":
            "The value must be an integer in thr range of 0 to 31. Its at the discretion of the implementer what to do if the value of the day is higher than the number of days in a given month.",
        "min": 0,
        "max": "*",
