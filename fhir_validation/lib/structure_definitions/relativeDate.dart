  ...
  "snapshot": {
    "element": [
      ...
      },
      {
        ...
        "comment":
            "This can be a reference to a particular event, or a kind of event (usually where the kind would not happen very frequently).",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "definition":
            "Defines the relationship between the event and the date.",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
      ...
      },
      {
        ...
        "definition":
            "The duration after the event that the date(time) will happen.",
        "min": 1,
        "max": "1",
        "base": {"path": "Element.extension", "min": 0, "max": "*"},
        "type": [
