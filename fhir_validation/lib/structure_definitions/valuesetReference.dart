    ...
    "element": [
      {
        ...
        "definition":
            "A logical reference (e.g. a reference to ValueSet.url) that identifies the value set/version that identifies the set of possible coded values this coding was chosen from or constrained by.",
        "comment":
            "If this extension is used with an [extensible binding](terminologies.html#extensible), and the concept comes from outside the bound valueset, the value set SHALL be different from the bound valueset.",
        "min": 0,
        "max": "1",
        ...
        "mapping": [
          {"identity": "v2", "map": "CWE."},
          {"identity": "rim", "map": "CD.valueSet/CD.valueSetVersion"}
        ]
      },
      {
        "id": "Extension.id",
