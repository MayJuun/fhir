    ...
    "element": [
      {
        ...
        "min": 0,
        "max": "*",
        "base": {"path": "TriggerDefinition", "min": 0, "max": "*"},
        "condition": ["ele-1"],
        "constraint": [
          {
            "key": "ele-1",
          ...
          },
          {
            ...
            "xpath":
                "not(exists(f:data)) or not(exists(*[starts-with(local-name(.), 'timing')]))",
            "source":
