    ...
    "element": [
      {
        ...
        "comment":
            "Considerable care must be used when using nullFlavor in this context of FHIR - more than any other concept, this is tied to the way v3 works, and FHIR is quite different. For instance, there is no notion of a \"proper value\" as opposed to any other value in FHIR. a NullFlavor should be understood to mean, \"why information is missing\", and the nulFlavors OTH, NINF, PINF, and TRC should not be used.",
        "min": 0,
        "max": "1",
        ...
        "mapping": [
          {"identity": "v2", "map": "n/a"},
          {"identity": "rim", "map": "ANY.nullFlavor"}
        ]
      },
      {
        "id": "Extension.id",
      ...
      },
      {
        ...
        "binding": {
          ...
          "strength": "required",
          "valueSet": "http://terminology.hl7.org/ValueSet/v3-NullFlavor|4.3.0"
        },
        "mapping": [
          {"identity": "rim", "map": "N/A"}
        ]
