const administrationMethodCodes = {
  ...
  "text": {
    "status": "generated",
    "div":
        "<div xmlns=\"http://www.w3.org/1999/xhtml\"><ul><li>Include codes from <a href=\"http://www.snomed.org/\"><code>http://snomed.info/sct</code></a> where concept  is-a  422096002 (Dosing instruction fragment)</li></ul></div>"
  },
  "extension": [
    {
    ...
    "include": [
      {
        ...
        "filter": [
          {"property": "concept", "op": "is-a", "value": "422096002"}
        ]
      }
    ]
  }
