const sequenceQualityMethod = {
  ...
  "text": {
    "status": "generated",
    "div":
        "<div xmlns=\"http://www.w3.org/1999/xhtml\"><p>This value set includes codes based on the following rules:</p><ul><li>Include all codes defined in <code>https://precision.fda.gov/apps/</code></li><li>Include all codes defined in <code>https://precision.fda.gov/jobs/</code></li></ul></div>"
  },
  "extension": [
    {
  ...
  "url": "http://hl7.org/fhir/ValueSet/sequence-quality-method",
  "identifier": [
    {
      "system": "urn:ietf:rfc:3986",
      "value": "urn:oid:2.16.840.1.113883.4.642.3.223"
    }
  ],
  "version": "4.3.0",
  "name": "FDA-Method",
