...
class ElementDefinition with _$ElementDefinition {
  ...
  ///
  /// [defaultValueFhirUuid] The value that should be used if there is no value
  /// stated in the instance (e.g. 'if not otherwise specified, the abstract is
  ///  false').
  ///
  /// [defaultValueFhirUuidElement] Extensions for defaultValueFhirUuid
  ///
  ...
  ///
  /// [fixedFhirUuid] Specifies a value that SHALL be exactly the value  for this
  /// element in the instance. For purposes of comparison, non-significant
  /// whitespace is ignored, and all values must be an exact match (case and
  ///  accent sensitive). Missing elements/attributes must also be missing.
  ///
  /// [fixedFhirUuidElement] Extensions for fixedFhirUuid
  ///
  ...
  ///
  /// [patternFhirUuid] Specifies a value that the value in the instance SHALL
  /// follow - that is, any value in the pattern must be found in the instance.
  /// Other additional values may be found too. This is effectively constraint
  ///  by example.
  /// When pattern[x] is used to constrain a primitive, it means that the value
  ...
  /// 3. If an array: it must match (recursively) the pattern value.
  ///
  /// [patternFhirUuidElement] Extensions for patternFhirUuid
  ///
  ...
  factory ElementDefinition({
    ...
    /// stated in the instance (e.g. 'if not otherwise specified, the abstract is
    ///  false').
    FhirUuid? defaultValueFhirUuid,

    /// [defaultValueFhirUuidElement] Extensions for defaultValueFhirUuid
    @JsonKey(name: '_defaultValueFhirUuid')
        Element? defaultValueFhirUuidElement,
    ...
    /// whitespace is ignored, and all values must be an exact match (case and
    ///  accent sensitive). Missing elements/attributes must also be missing.
    FhirUuid? fixedFhirUuid,

    /// [fixedFhirUuidElement] Extensions for fixedFhirUuid
    @JsonKey(name: '_fixedFhirUuid')
        Element? fixedFhirUuidElement,
    ...
    /// 2. If a complex object: it must match (recursively) the pattern value
    /// 3. If an array: it must match (recursively) the pattern value.
    FhirUuid? patternFhirUuid,

    /// [patternFhirUuidElement] Extensions for patternFhirUuid
    @JsonKey(name: '_patternFhirUuid')
        Element? patternFhirUuidElement,
...
class ElementDefinitionExample with _$ElementDefinitionExample {
  ...
  ///
  /// [valueFhirUuid] The actual value for the element, which must be one of the
  ///  types allowed for this element.
  ///
