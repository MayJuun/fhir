...
Attachment _$AttachmentFromJson(Map<String, dynamic> json) => Attachment(
      ...
      pagesElement: json['pagesElement'] == null
          ? null
          : Element.fromJson(json['pagesElement'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$AttachmentToJson(Attachment instance) {
  ...
  writeNotNull('pagesElement', instance.pagesElement?.toJson());
  return val;
}
...
SampledData _$SampledDataFromJson(Map<String, dynamic> json) => SampledData(
      ...
      intervalElement: json['intervalElement'] == null
          ? null
          : Element.fromJson(json['intervalElement'] as Map<String, dynamic>),
      intervalUnit: json['intervalUnit'] == null
          ? null
          : Code.fromJson(json['intervalUnit']),
      intervalUnitElement: json['intervalUnitElement'] == null
          ? null
          : Element.fromJson(
              json['intervalUnitElement'] as Map<String, dynamic>),
...
Map<String, dynamic> _$SampledDataToJson(SampledData instance) {
  ...
  writeNotNull('intervalElement', instance.intervalElement?.toJson());
  writeNotNull('intervalUnit', instance.intervalUnit?.toJson());
  writeNotNull('intervalUnitElement', instance.intervalUnitElement?.toJson());
...
Map<String, dynamic> _$HumanNameToJson(HumanName instance) {
  ...
  writeNotNull(
      'prefixElement', instance.prefixElement?.map((e) => e.toJson()).toList());
  writeNotNull('suffix', instance.suffix);
  writeNotNull(
      'suffixElement', instance.suffixElement?.map((e) => e.toJson()).toList());
  writeNotNull('period', instance.period?.toJson());
  return val;
}
