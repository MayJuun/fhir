...
class Claim extends Resource {
  const Claim({
    super.resourceType = R5ResourceType.Claim,
    super.id,
    super.meta,
...
class ClaimResponse extends Resource {
  const ClaimResponse({
    super.resourceType = R5ResourceType.ClaimResponse,
    super.id,
    super.meta,
    required super.implicitRules,
    @JsonKey(name: '_implicitRules') super.implicitRulesElement,
...
class Invoice extends Resource {
  const Invoice({
    super.resourceType = R5ResourceType.Invoice,
    super.id,
    super.meta,
    required super.implicitRules,
    @JsonKey(name: '_implicitRules') super.implicitRulesElement,
    ...
    @JsonKey(name: '_cancelledReason') required this.cancelledReasonElement,
    required this.type,
    ...
    @JsonKey(name: '_periodDate') required this.periodDateElement,
    required this.periodPeriod,
    ...
    @JsonKey(name: '_paymentTerms') required this.paymentTermsElement,
    required this.note,
  });
  final R5ResourceType resourceType;
