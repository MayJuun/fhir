...
@Default(R5ResourceType.AdministrableProductDefinition)required  this.resourceType,
required this.id,
required this.meta,
...
Map<String, dynamic> toJson() => _$AdministrableProductDefinitionPropertyToJson(this);
}
...
Map<String, dynamic> toJson() => _$AdministrableProductDefinitionRouteOfAdministrationToJson(this);
}
...
Map<String, dynamic> toJson() => _$AdministrableProductDefinitionTargetSpeciesToJson(this);
}
...
@JsonKey('__supportingInformation') required this.supportingInformationElement,
});
...
Map<String, dynamic> toJson() => _$AdministrableProductDefinitionWithdrawalPeriodToJson(this);
}
...
factory ClinicalUseDefinition.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionFromJson(json);
...
factory ClinicalUseDefinitionContraindication.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionContraindicationFromJson(json);
Map<String, dynamic> toJson() => _$ClinicalUseDefinitionContraindicationToJson(this);
}
...
factory ClinicalUseDefinitionOtherTherapy.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionOtherTherapyFromJson(json);
Map<String, dynamic> toJson() => _$ClinicalUseDefinitionOtherTherapyToJson(this);
}
...
final Expression? applicability;
final List<ClinicalUseDefinitionOtherTherapy>? otherTherapy;
factory ClinicalUseDefinitionIndication.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionIndicationFromJson(json);
Map<String, dynamic> toJson() => _$ClinicalUseDefinitionIndicationToJson(this);
}
...
factory ClinicalUseDefinitionInteraction.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionInteractionFromJson(json);
Map<String, dynamic> toJson() => _$ClinicalUseDefinitionInteractionToJson(this);
}
...
factory ClinicalUseDefinitionInteractant.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionInteractantFromJson(json);
Map<String, dynamic> toJson() => _$ClinicalUseDefinitionInteractantToJson(this);
}
...
factory ClinicalUseDefinitionUndesirableEffect.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionUndesirableEffectFromJson(json);
Map<String, dynamic> toJson() => _$ClinicalUseDefinitionUndesirableEffectToJson(this);
}
...
final CodeableConcept? code;
factory ClinicalUseDefinitionWarning.fromJson(Map<String, dynamic> json) => _$ClinicalUseDefinitionWarningFromJson(json);
...
@JsonKey(name: '_allergenicIndicator')required  this.allergenicIndicatorElement,
...
factory IngredientManufacturer.fromJson(Map<String, dynamic> json) => _$IngredientManufacturerFromJson(json);
...
@Default(R5ResourceType.ManufacturedItemDefinition)required  this.resourceType,
required this.id,
required this.meta,
required this.implicitRules,
@JsonKey(name: '_implicitRules')required  this.implicitRulesElement,
...
Map<String, dynamic> toJson() => _$ManufacturedItemDefinitionPropertyToJson(this);
}
...
// factory ManufacturedItemDefinitionConstituent.fromJson(Map<String, dynamic> json) => _$ManufacturedItemDefinitionConstituentFromJson(json);
// Map<String, dynamic> toJson() => _$ManufacturedItemDefinitionConstituentToJson(this);
// }
...
@Default(R5ResourceType.MedicinalProductDefinition)required  this.resourceType,
required this.id,
required this.meta,
required this.implicitRules,
@JsonKey(name: '_implicitRules')required  this.implicitRulesElement,
...
Map<String, dynamic> toJson() => _$MedicinalProductDefinitionContactToJson(this);
}
...
final CodeableConcept type;
factory MedicinalProductDefinitionPart.fromJson(Map<String, dynamic> json) => _$MedicinalProductDefinitionPartFromJson(json);
...
factory MedicinalProductDefinitionUsage.fromJson(Map<String, dynamic> json) => _$MedicinalProductDefinitionUsageFromJson(json);
Map<String, dynamic> toJson() => _$MedicinalProductDefinitionUsageToJson(this);
}
...
Map<String, dynamic> toJson() => _$MedicinalProductDefinitionCrossReferenceToJson(this);
}
...
factory MedicinalProductDefinitionOperation.fromJson(Map<String, dynamic> json) => _$MedicinalProductDefinitionOperationFromJson(json);
Map<String, dynamic> toJson() => _$MedicinalProductDefinitionOperationToJson(this);
}
...
final Element? valueBooleanElement;
final Attachment? valueAttachment;
factory MedicinalProductDefinitionCharacteristic.fromJson(Map<String, dynamic> json) => _$MedicinalProductDefinitionCharacteristicFromJson(json);
Map<String, dynamic> toJson() => _$MedicinalProductDefinitionCharacteristicToJson(this);
}
...
@Default(R5ResourceType.PackagedProductDefinition)required  this.resourceType,
required this.id,
required this.meta,
required this.implicitRules,
@JsonKey(name: '_implicitRules')required  this.implicitRulesElement,
...
@JsonKey(name: '_copackagedIndicator')required  this.copackagedIndicatorElement,
required this.manufacturer,
required this.attachedDocument,
...
final CodeableConcept? code;
final CodeableConcept? jurisdiction;
factory PackagedProductDefinitionLegalStatusOfSupply.fromJson(Map<String, dynamic> json) => _$PackagedProductDefinitionLegalStatusOfSupplyFromJson(json);
Map<String, dynamic> toJson() => _$PackagedProductDefinitionLegalStatusOfSupplyToJson(this);
}
...
factory PackagedProductDefinitionPackaging.fromJson(Map<String, dynamic> json) => _$PackagedProductDefinitionPackagingFromJson(json);
Map<String, dynamic> toJson() => _$PackagedProductDefinitionPackagingToJson(this);
}
...
Map<String, dynamic> toJson() => _$PackagedProductDefinitionPropertyToJson(this);
}
...
Map<String, dynamic> toJson() => _$PackagedProductDefinitionContainedItemToJson(this);
}
...
factory SubstanceDefinitionCharacterization.fromJson(Map<String, dynamic> json) => _$SubstanceDefinitionCharacterizationFromJson(json);
Map<String, dynamic> toJson() => _$SubstanceDefinitionCharacterizationToJson(this);
}
...
Map<String, dynamic> toJson() => _$SubstanceDefinitionMolecularWeightToJson(this);
}
...
@JsonKey('__molecularFormulaByMoiety') required this.molecularFormulaByMoietyElement,
required this.molecularWeight,
required this.technique,
...
Map<String, dynamic> toJson() => _$SubstanceDefinitionRepresentationToJson(this);
}
...
Map<String, dynamic> toJson() => _$SubstanceDefinitionRelationshipToJson(this);
}
...
factory SubstanceDefinitionSourceMaterial.fromJson(Map<String, dynamic> json) => _$SubstanceDefinitionSourceMaterialFromJson(json);
Map<String, dynamic> toJson() => _$SubstanceDefinitionSourceMaterialToJson(this);
}
...
@JsonKey(name: '_areaOfHybridisation')required  this.areaOfHybridisationElement,
...
@JsonKey('__averageMolecularFormula') required this.averageMolecularFormulaElement,
...
@JsonKey('__nTerminalModification') required this.nTerminalModificationElement,
required this.cTerminalModificationId,
required this.cTerminalModification,
@JsonKey('__cTerminalModification') required this.cTerminalModificationElement,
});
final String? id;
final List<FhirExtension>? extension_;
final List<FhirExtension>? modifierExtension;
...
@Default(R5ResourceType.SubstanceReferenceInformation)required  this.resourceType,
required this.id,
required this.meta,
required this.implicitRules,
@JsonKey(name: '_implicitRules')required  this.implicitRulesElement,
...
@JsonKey('__geographicalLocation') required this.geographicalLocationElement,
...
@JsonKey('__intraspecificDescription') required this.intraspecificDescriptionElement,
...
@JsonKey(name: '_maternalOrganismId')required  this.maternalOrganismIdElement,
required this.maternalOrganismName,
@JsonKey('__maternalOrganismName') required this.maternalOrganismNameElement,
required this.paternalOrganismId,
@JsonKey(name: '_paternalOrganismId')required  this.paternalOrganismIdElement,
required this.paternalOrganismName,
@JsonKey('__paternalOrganismName') required this.paternalOrganismNameElement,
