...
class ElementDefinitionSlicing {
  const ElementDefinitionSlicing({
    ...
    this.representation,
    @JsonKey(name: '__representation') this.representationElement,
    this.sliceName,
    @JsonKey(name: '__sliceName') this.sliceNameElement,
    this.sliceIsConstraining,
    @JsonKey(name: '__sliceIsConstraining') this.sliceIsConstrainingElement,
    this.label,
    @JsonKey(name: '__label') this.labelElement,
    this.code,
    this.slicing,
    this.short,
    @JsonKey(name: '__short') this.shortElement,
    this.definition,
    @JsonKey(name: '__definition') this.definitionElement,
    this.comment,
    @JsonKey(name: '__comment') this.commentElement,
    this.requirements,
    @JsonKey(name: '__requirements') this.requirementsElement,
    this.alias,
    ...
    @JsonKey(name: '__contentReference') this.contentReferenceElement,
    this.type,
    ...
    @JsonKey(name: '__meaningWhenMissing') this.meaningWhenMissingElement,
    this.orderMeaning,
    @JsonKey(name: '__orderMeaning') this.orderMeaningElement,
    this.fixedBase64Binary,
    @JsonKey(name: '__fixedBase64Binary') this.fixedBase64BinaryElement,
    this.fixedBoolean,
    @JsonKey(name: '__fixedBoolean') this.fixedBooleanElement,
    this.fixedCanonical,
    @JsonKey(name: '__fixedCanonical') this.fixedCanonicalElement,
    this.fixedCode,
    @JsonKey(name: '__fixedCode') this.fixedCodeElement,
    this.fixedDate,
    @JsonKey(name: '__fixedDate') this.fixedDateElement,
    this.fixedDateTime,
    @JsonKey(name: '__fixedDateTime') this.fixedDateTimeElement,
    this.fixedDecimal,
    @JsonKey(name: '__fixedDecimal') this.fixedDecimalElement,
    this.fixedId,
    @JsonKey(name: '__fixedId') this.fixedIdElement,
    this.fixedInstant,
    @JsonKey(name: '__fixedInstant') this.fixedInstantElement,
    this.fixedInteger,
    @JsonKey(name: '__fixedInteger') this.fixedIntegerElement,
    this.fixedMarkdown,
    @JsonKey(name: '__fixedMarkdown') this.fixedMarkdownElement,
    this.fixedOid,
    @JsonKey(name: '__fixedOid') this.fixedOidElement,
    this.fixedPositiveInt,
    @JsonKey(name: '__fixedPositiveInt') this.fixedPositiveIntElement,
    this.fixedString,
    @JsonKey(name: '__fixedString') this.fixedStringElement,
    this.fixedTime,
    @JsonKey(name: '__fixedTime') this.fixedTimeElement,
    this.fixedUnsignedInt,
    @JsonKey(name: '__fixedUnsignedInt') this.fixedUnsignedIntElement,
    this.fixedUri,
    @JsonKey(name: '__fixedUri') this.fixedUriElement,
    this.fixedUrl,
    @JsonKey(name: '__fixedUrl') this.fixedUrlElement,
    this.fixedUuid,
    @JsonKey(name: '__fixedUuid') this.fixedUuidElement,
    this.fixedAddress,
    this.fixedAge,
    ...
    @JsonKey(name: '__patternBase64Binary') this.patternBase64BinaryElement,
    this.patternBoolean,
    @JsonKey(name: '__patternBoolean') this.patternBooleanElement,
    this.patternCanonical,
    @JsonKey(name: '__patternCanonical') this.patternCanonicalElement,
    this.patternCode,
    @JsonKey(name: '__patternCode') this.patternCodeElement,
    this.patternDate,
    @JsonKey(name: '__patternDate') this.patternDateElement,
    this.patternDateTime,
    @JsonKey(name: '__patternDateTime') this.patternDateTimeElement,
    this.patternDecimal,
    @JsonKey(name: '__patternDecimal') this.patternDecimalElement,
    this.patternId,
    @JsonKey(name: '__patternId') this.patternIdElement,
    this.patternInstant,
    @JsonKey(name: '__patternInstant') this.patternInstantElement,
    this.patternInteger,
    @JsonKey(name: '__patternInteger') this.patternIntegerElement,
    this.patternMarkdown,
    @JsonKey(name: '__patternMarkdown') this.patternMarkdownElement,
    this.patternOid,
    @JsonKey(name: '__patternOid') this.patternOidElement,
    this.patternPositiveInt,
    @JsonKey(name: '__patternPositiveInt') this.patternPositiveIntElement,
    this.patternString,
    @JsonKey(name: '__patternString') this.patternStringElement,
    this.patternTime,
    @JsonKey(name: '__patternTime') this.patternTimeElement,
    this.patternUnsignedInt,
    @JsonKey(name: '__patternUnsignedInt') this.patternUnsignedIntElement,
    this.patternUri,
    @JsonKey(name: '__patternUri') this.patternUriElement,
    this.patternUrl,
    @JsonKey(name: '__patternUrl') this.patternUrlElement,
    this.patternUuid,
    @JsonKey(name: '__patternUuid') this.patternUuidElement,
    this.patternAddress,
    this.patternAge,
    ...
    this.example,
    this.minValueDate,
    @JsonKey(name: '__minValueDate') this.minValueDateElement,
    this.minValueDateTime,
    @JsonKey(name: '__minValueDateTime') this.minValueDateTimeElement,
    this.minValueInstant,
    @JsonKey(name: '__minValueInstant') this.minValueInstantElement,
    this.minValueTime,
    @JsonKey(name: '__minValueTime') this.minValueTimeElement,
    this.minValueDecimal,
    @JsonKey(name: '__minValueDecimal') this.minValueDecimalElement,
    this.minValueInteger,
    @JsonKey(name: '__minValueInteger') this.minValueIntegerElement,
    this.minValuePositiveInt,
    @JsonKey(name: '__minValuePositiveInt') this.minValuePositiveIntElement,
    this.minValueUnsignedInt,
    @JsonKey(name: '__minValueUnsignedInt') this.minValueUnsignedIntElement,
    this.minValueQuantity,
    this.maxValueDate,
    @JsonKey(name: '__maxValueDate') this.maxValueDateElement,
    this.maxValueDateTime,
    @JsonKey(name: '__maxValueDateTime') this.maxValueDateTimeElement,
    this.maxValueInstant,
    @JsonKey(name: '__maxValueInstant') this.maxValueInstantElement,
    this.maxValueTime,
    @JsonKey(name: '__maxValueTime') this.maxValueTimeElement,
    this.maxValueDecimal,
    @JsonKey(name: '__maxValueDecimal') this.maxValueDecimalElement,
    this.maxValueInteger,
    @JsonKey(name: '__maxValueInteger') this.maxValueIntegerElement,
    this.maxValuePositiveInt,
    @JsonKey(name: '__maxValuePositiveInt') this.maxValuePositiveIntElement,
    this.maxValueUnsignedInt,
    @JsonKey(name: '__maxValueUnsignedInt') this.maxValueUnsignedIntElement,
    this.maxValueQuantity,
    this.maxLength,
    @JsonKey(name: '__maxLength') this.maxLengthElement,
    this.condition,
    ...
    this.ordered,
    @JsonKey(name: '__ordered') this.orderedElement,
    this.rules,
    @JsonKey(name: '__rules') this.rulesElement,
  });
  final String? id;
...
class ElementDefinitionType {
  const ElementDefinitionType({
    ...
    this.profile,
    @JsonKey(name: '__profile') this.profileElement,
    this.targetProfile,
    this.aggregation,
    @JsonKey(name: '__aggregation') this.aggregationElement,
    this.versioning,
    @JsonKey(name: '__versioning') this.versioningElement,
  });
  final String? id;
...
class ElementDefinitionConstraint {
  const ElementDefinitionConstraint({
    ...
    this.modifierExtension,
    this.key,
    @JsonKey(name: '__key') this.keyElement,
    this.requirements,
    @JsonKey(name: '__requirements') this.requirementsElement,
    this.severity,
    @JsonKey(name: '__severity') this.severityElement,
    this.human,
    @JsonKey(name: '__human') this.humanElement,
    this.expression,
...
class ElementDefinitionBinding {
  const ElementDefinitionBinding({
    ...
    this.modifierExtension,
    this.strength,
    @JsonKey(name: '__strength') this.strengthElement,
    this.description,
    @JsonKey(name: '__description') this.descriptionElement,
    this.valueSet,
  });
