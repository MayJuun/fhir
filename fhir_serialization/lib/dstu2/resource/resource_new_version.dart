...
//     return Meta(
//       id: oldMeta.id,
//       extension_: oldMeta.extension_,
//       fhirComments: oldMeta.fhirComments,
//       versionId: Id(version.toString()),
//       lastUpdated: Instant(DateTime.now().toUtc()),
//       lastUpdatedElement: oldMeta.lastUpdatedElement,
//       profile: oldMeta.profile,
//       security: oldMeta.security,
//       tag: oldMeta.tag,
//     );
//   }
// }
...
//       return (resource as Account) =  _updateMetaVersion(meta ?? resource.meta);
