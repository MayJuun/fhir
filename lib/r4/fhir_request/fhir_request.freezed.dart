...
mixin _$FhirRequest {
  ...
  Result when<Result extends Object>({
    ...
    @required
        Result search(
            ...
            Client client),
    @required
        Result searchAll(Uri base, bool pretty, Summary summary, String format,
  ...
  Result map<Result extends Object>({
    @required Result read(_FhirReadRequest value),
    @required Result vRead(_FhirVReadRequest value),
    @required Result update(_FhirUpdateRequest value),
    @required Result patch(_FhirPatchRequest value),
    @required Result delete(_FhirDeleteRequest value),
    @required Result create(_FhirCreateRequest value),
    @required Result search(_FhirSearchRequest value),
    @required Result searchAll(_FhirSearchAllRequest value),
    @required Result capabilities(_FhirCapabilitiesRequest value),
    @required Result transaction(_FhirTransactionRequest value),
    @required Result batch(_FhirBatchRequest value),
    @required Result history(_FhirHistoryRequest value),
    @required Result historyType(_FhirHistoryTypeRequest value),
    @required Result historyAll(_FhirHistoryAllRequest value),
    @required Result operation(_FhirOperationRequest value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result read(_FhirReadRequest value),
    Result vRead(_FhirVReadRequest value),
    Result update(_FhirUpdateRequest value),
    Result patch(_FhirPatchRequest value),
    Result delete(_FhirDeleteRequest value),
    Result create(_FhirCreateRequest value),
    Result search(_FhirSearchRequest value),
    Result searchAll(_FhirSearchAllRequest value),
    Result capabilities(_FhirCapabilitiesRequest value),
    Result transaction(_FhirTransactionRequest value),
    Result batch(_FhirBatchRequest value),
    Result history(_FhirHistoryRequest value),
    Result historyType(_FhirHistoryTypeRequest value),
    Result historyAll(_FhirHistoryAllRequest value),
    Result operation(_FhirOperationRequest value),
    @required Result orElse(),
  });
