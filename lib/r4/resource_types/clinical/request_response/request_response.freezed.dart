...
class _$RequestResponseTearOff {
  const _$RequestResponseTearOff();
...
const $RequestResponse = _$RequestResponseTearOff();
...
class _$DeviceUseStatementCopyWithImpl<$Res>
    extends _$RequestResponseCopyWithImpl<$Res>
...
class _$DeviceUseStatement implements DeviceUseStatement {
  ...
  @override
  String toString() {
    return 'RequestResponse.deviceUseStatement(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, identifier: $identifier, basedOn: $basedOn, status: $status, subject: $subject, derivedFrom: $derivedFrom, timingTiming: $timingTiming, timingPeriod: $timingPeriod, timingDateTime: $timingDateTime, recordedOn: $recordedOn, source: $source, device: $device, reasonCode: $reasonCode, reasonReference: $reasonReference, bodySite: $bodySite, note: $note)';
  }
...
abstract class DeviceUseStatement implements RequestResponse {
...
class _$SupplyDelivery implements SupplyDelivery {
  ...
  @override
  String toString() {
    return 'RequestResponse.supplyDelivery(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, identifier: $identifier, basedOn: $basedOn, partOf: $partOf, status: $status, patient: $patient, type: $type, suppliedItem: $suppliedItem, occurrenceDateTime: $occurrenceDateTime, occurrencePeriod: $occurrencePeriod, occurrenceTiming: $occurrenceTiming, supplier: $supplier, destination: $destination, receiver: $receiver)';
  }
...
abstract class SupplyDelivery implements RequestResponse {
...
class _$SupplyDeliverySuppliedItem implements SupplyDeliverySuppliedItem {
  ...
  @override
  String toString() {
    return 'RequestResponse.supplyDeliverySuppliedItem(id: $id, extension: $extension, modifierExtension: $modifierExtension, quantity: $quantity, itemCodeableConcept: $itemCodeableConcept, itemReference: $itemReference)';
  }
...
abstract class SupplyDeliverySuppliedItem implements RequestResponse {
...
class _$SupplyRequest implements SupplyRequest {
  ...
  @override
  String toString() {
    return 'RequestResponse.supplyRequest(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, category: $category, priority: $priority, itemCodeableConcept: $itemCodeableConcept, itemReference: $itemReference, quantity: $quantity, parameter: $parameter, occurrenceDateTime: $occurrenceDateTime, occurrencePeriod: $occurrencePeriod, occurrenceTiming: $occurrenceTiming, authoredOn: $authoredOn, requester: $requester, supplier: $supplier, reasonCode: $reasonCode, reasonReference: $reasonReference, deliverFrom: $deliverFrom, deliverTo: $deliverTo)';
  }
...
abstract class SupplyRequest implements RequestResponse {
...
class _$SupplyRequestParameter implements SupplyRequestParameter {
  ...
  @override
  String toString() {
    return 'RequestResponse.supplyRequestParameter(id: $id, extension: $extension, modifierExtension: $modifierExtension, code: $code, valueCodeableConcept: $valueCodeableConcept, valueQuantity: $valueQuantity, valueRange: $valueRange, valueBoolean: $valueBoolean)';
  }
...
abstract class SupplyRequestParameter implements RequestResponse {
...
class _$GuidanceResponse implements GuidanceResponse {
  ...
  @override
  String toString() {
    return 'RequestResponse.guidanceResponse(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, requestIdentifier: $requestIdentifier, identifier: $identifier, moduleUri: $moduleUri, moduleCanonical: $moduleCanonical, moduleCodeableConcept: $moduleCodeableConcept, status: $status, subject: $subject, encounter: $encounter, occurrenceDateTime: $occurrenceDateTime, performer: $performer, reasonCode: $reasonCode, reasonReference: $reasonReference, note: $note, evaluationMessage: $evaluationMessage, outputParameters: $outputParameters, result: $result, dataRequirement: $dataRequirement)';
  }
...
abstract class GuidanceResponse implements RequestResponse {
...
class _$DeviceRequest implements DeviceRequest {
  ...
  @override
  String toString() {
    return 'RequestResponse.deviceRequest(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, identifier: $identifier, instantiatesCanonical: $instantiatesCanonical, instantiatesUri: $instantiatesUri, basedOn: $basedOn, priorRequest: $priorRequest, groupIdentifier: $groupIdentifier, status: $status, intent: $intent, priority: $priority, codeReference: $codeReference, codeCodeableConcept: $codeCodeableConcept, parameter: $parameter, subject: $subject, encounter: $encounter, occurrenceDateTime: $occurrenceDateTime, occurrencePeriod: $occurrencePeriod, occurrenceTiming: $occurrenceTiming, authoredOn: $authoredOn, requester: $requester, performerType: $performerType, performer: $performer, reasonCode: $reasonCode, reasonReference: $reasonReference, insurance: $insurance, supportingInfo: $supportingInfo, note: $note, relevantHistory: $relevantHistory)';
  }
...
abstract class DeviceRequest implements RequestResponse {
...
class _$DeviceRequestParameter implements DeviceRequestParameter {
  ...
  @override
  String toString() {
    return 'RequestResponse.deviceRequestParameter(id: $id, extension: $extension, modifierExtension: $modifierExtension, code: $code, valueCodeableConcept: $valueCodeableConcept, valueQuantity: $valueQuantity, valueRange: $valueRange, valueBoolean: $valueBoolean)';
  }
...
abstract class DeviceRequestParameter implements RequestResponse {
...
class _$CommunicationRequest implements CommunicationRequest {
  ...
  @override
  String toString() {
    return 'RequestResponse.communicationRequest(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension: $extension, modifierExtension: $modifierExtension, identifier: $identifier, basedOn: $basedOn, replaces: $replaces, groupIdentifier: $groupIdentifier, status: $status, statusReason: $statusReason, category: $category, priority: $priority, doNotPerform: $doNotPerform, medium: $medium, subject: $subject, about: $about, encounter: $encounter, payload: $payload, occurrenceDateTime: $occurrenceDateTime, occurrencePeriod: $occurrencePeriod, authoredOn: $authoredOn, requester: $requester, recipient: $recipient, sender: $sender, reasonCode: $reasonCode, reasonReference: $reasonReference, note: $note)';
  }
...
abstract class CommunicationRequest implements RequestResponse {
...
class _$CommunicationRequestPayload implements CommunicationRequestPayload {
  ...
  @override
  String toString() {
    return 'RequestResponse.communicationRequestPayload(id: $id, extension: $extension, modifierExtension: $modifierExtension, contentString: $contentString, contentAttachment: $contentAttachment, contentReference: $contentReference)';
  }
...
abstract class CommunicationRequestPayload implements RequestResponse {
...
abstract class Communication implements RequestResponse {
...
class _$CommunicationPayload implements CommunicationPayload {
  ...
  @override
  String toString() {
    return 'RequestResponse.communicationPayload(id: $id, extension: $extension, modifierExtension: $modifierExtension, contentString: $contentString, contentAttachment: $contentAttachment, contentReference: $contentReference)';
  }
...
abstract class CommunicationPayload implements RequestResponse {
