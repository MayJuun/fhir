...
@freezed
abstract class AdverseEvent implements _$AdverseEvent , Resource {
AdverseEvent._();
...
@freezed
abstract class AllergyIntolerance implements _$AllergyIntolerance , Resource {
...
@freezed
abstract class ClinicalImpression implements _$ClinicalImpression , Resource {
...
@freezed
abstract class Condition implements _$Condition , Resource {
Condition._();
factory Condition({
@JsonKey(defaultValue: 'className') @required String resourceType,
  Id id,
...
@freezed
abstract class DetectedIssue implements _$DetectedIssue , Resource {
DetectedIssue._();
...
@freezed
abstract class FamilyMemberHistory implements _$FamilyMemberHistory , Resource {
...
@freezed
abstract class Procedure implements _$Procedure , Resource {
Procedure._();
factory Procedure({
@JsonKey(defaultValue: 'className') @required String resourceType,
  Id id,
