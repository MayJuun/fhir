...
Map<String, dynamic> _$_$DeviceUseStatementToJson(
    ...
    <String, dynamic>{
      ...
      'status': _$DeviceUseStatementStatusEnumMap[instance.status],
...
Map<String, dynamic> _$_$SupplyDeliveryToJson(_$SupplyDelivery instance) =>
    <String, dynamic>{
      ...
      'status': _$SupplyDeliveryStatusEnumMap[instance.status],
...
Map<String, dynamic> _$_$SupplyRequestToJson(_$SupplyRequest instance) =>
    <String, dynamic>{
      ...
      'modifierExtension': instance.modifierExtension,
      'identifier': instance.identifier,
      'status': _$SupplyRequestStatusEnumMap[instance.status],
...
Map<String, dynamic> _$_$GuidanceResponseToJson(_$GuidanceResponse instance) =>
    <String, dynamic>{
      ...
      'status': _$GuidanceResponseStatusEnumMap[instance.status],
      'subject': instance.subject,
