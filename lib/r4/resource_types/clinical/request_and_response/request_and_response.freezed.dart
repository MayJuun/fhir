...
class _$_DeviceRequestParameter implements _DeviceRequestParameter {
  ...
  @override
  String toString() {
    return 'DeviceRequestParameter(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, code: $code, valueCodeableConcept: $valueCodeableConcept, valueQuantity: $valueQuantity, valueRange: $valueRange, valueBoolean: $valueBoolean)';
  }
...
abstract class _DeviceRequestParameter implements DeviceRequestParameter {
  const factory _DeviceRequestParameter(
      ...
      Quantity valueQuantity,
      Range valueRange,
      Boolean valueBoolean}) = _$_DeviceRequestParameter;
...
class _$_SupplyDelivery implements _SupplyDelivery {
  ...
  @override
  String toString() {
    return 'SupplyDelivery(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, basedOn: $basedOn, partOf: $partOf, status: $status, patient: $patient, type: $type, suppliedItem: $suppliedItem, occurrenceDateTime: $occurrenceDateTime, occurrencePeriod: $occurrencePeriod, occurrenceTiming: $occurrenceTiming, supplier: $supplier, destination: $destination, receiver: $receiver)';
  }
...
class _$_SupplyRequestParameter implements _SupplyRequestParameter {
  ...
  @override
  String toString() {
    return 'SupplyRequestParameter(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, code: $code, valueCodeableConcept: $valueCodeableConcept, valueQuantity: $valueQuantity, valueRange: $valueRange, valueBoolean: $valueBoolean)';
  }
...
abstract class _SupplyRequestParameter implements SupplyRequestParameter {
  const factory _SupplyRequestParameter(
      ...
      Quantity valueQuantity,
      Range valueRange,
      Boolean valueBoolean}) = _$_SupplyRequestParameter;
