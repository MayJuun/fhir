...
@JsonKey(unknownEnumValue: VisionPrescriptionPrismBase.unknown) VisionPrescriptionPrismBase base,
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
  ...
  List<Reference> goal,
@JsonKey(unknownEnumValue: CarePlanDetailStatus.unknown) CarePlanDetailStatus status,
  @JsonKey(name: '_status')  Element statusElement,
...
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
   List<FhirExtension> modifierExtension,
   List<Identifier> identifier,
@JsonKey(unknownEnumValue: GoalLifecycleStatus.unknown) GoalLifecycleStatus lifecycleStatus,
...
@freezed
abstract class NutritionOrderEnteralFormula  implements _$NutritionOrderEnteralFormula {
...
@freezed
abstract class NutritionOrderAdministration  implements _$NutritionOrderAdministration {
...
@freezed
abstract class RequestGroupRelatedAction  implements _$RequestGroupRelatedAction {
...
@freezed
abstract class VisionPrescription with Resource  implements _$VisionPrescription {
...
@freezed
abstract class VisionPrescriptionLensSpecification  implements _$VisionPrescriptionLensSpecification {
...
@JsonKey(unknownEnumValue: VisionPrescriptionLensSpecificationEye.unknown) VisionPrescriptionLensSpecificationEye eye,
