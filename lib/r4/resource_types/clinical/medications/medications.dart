...
co  nst factory Medications.medication({
    String resourceType,
    Id id,
    Meta meta,
    FhirUri implicitRules,
    Code language,
    Narrative text,
    List<dynamic> containe  List<FhirExtension> extension,
  List<FhirExtension> modifierExtension,
  List<Identifier> identifier,
...
co  nst factory Medications.medicationIngredient({
    String id,
    List<FhirExtension> extension,
  ...
  const factory Medications.medicationBatch({
    String id,
    List<FhirExtension> extension,
    List<FhirExtension  String lotNumber,
 ...
 co nst factory Medications.medicationRequest({
  ...
  FhirDateTime authoredOn,
    ...
    List<Reference> basedOn,
    Identifier groupIdentifie  CodeableConcept courseOfTherapyType,
 ...
 co nst factory Medications.immunization({
  ...
  Quantity doseQuantity,
    ...
    List<Reference> reasonReference,
    bool isSubpotent,
    List<Cod  List<ImmunizationEducation> education,
...
co  nst factory Medications.immunizationEducation({
    String id,
    List<FhirExtension> extension,
    List<FhirExtension> modifierExtension,
    String documentType,
...
co  nst factory Medications.immunizationReaction({
    String id,
    List<FhirExtension> extension,
    List<FhirExtension> modifierExtension,
    FhirDateTime date,
...
cl  ass MedicationKnowledgeRelatedMedicationKnowledge {
    String id,
    List<FhirExtension> extension,
    List<FhirExtension> modifierExtension,
    CodeableConcept type,
