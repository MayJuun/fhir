...
@freezed
abstract class Measure implements _$Measure , Resource {
Measure._();
factory Measure({
...
@freezed
abstract class MeasureReport implements _$MeasureReport , Resource {
MeasureReport._();
...
@JsonKey(defaultValue: 'className') @required String resourceType,
  ...
  List<FhirExtension> modifierExtension,
  List<Identifier> identifier,
@JsonKey(unknownEnumValue: MeasureReportStatus.unknown) MeasureReportStatus status,
  @JsonKey(name: '_status')   Element statusElement,
@JsonKey(unknownEnumValue: MeasureReportType.unknown) MeasureReportType type,
...
@freezed
abstract class TestReport implements _$TestReport , Resource {
TestReport._();
factory TestReport({
@JsonKey(defaultValue: 'className') @required String resourceType,
  Id id,
  ...
  String name,
  @JsonKey(name: '_name')   Element nameElement,
@JsonKey(unknownEnumValue: TestReportStatus.unknown) TestReportStatus status,
  @JsonKey(name: '_status')   Element statusElement,
  @required Reference testScript,
@JsonKey(unknownEnumValue: TestReportResult.unknown) TestReportResult result,
...
factory TestReportParticipant({
 ...
 List<FhirExtension> extension,
 List<FhirExtension> modifierExtension,
@JsonKey(unknownEnumValue: TestReportParticipantType.unknown) TestReportParticipantType type,
  @JsonKey(name: '_type')  Element typeElement,
 FhirUri uri,
...
factory TestReportOperation({
 ...
 List<FhirExtension> extension,
 List<FhirExtension> modifierExtension,
@JsonKey(unknownEnumValue: TestReportOperationResult.unknown) TestReportOperationResult result,
  @JsonKey(name: '_result')  Element resultElement,
 Markdown message,
...
factory TestReportAssert({
 ...
 List<FhirExtension> extension,
 List<FhirExtension> modifierExtension,
@JsonKey(unknownEnumValue: TestReportAssertResult.unknown) TestReportAssertResult result,
  @JsonKey(name: '_result')  Element resultElement,
 Markdown message,
  @JsonKey(name: '_message')  Element messageElement,
 String detail,
...
@freezed
abstract class TestScript implements _$TestScript , Resource {
TestScript._();
factory TestScript({
@JsonKey(defaultValue: 'className') @required String resourceType,
  Id id,
  ...
  String title,
  @JsonKey(name: '_title')   Element titleElement,
@JsonKey(unknownEnumValue: TestScriptStatus.unknown) TestScriptStatus status,
  @JsonKey(name: '_status')   Element statusElement,
  Boolean experimental,
  @JsonKey(name: '_experimental')   Element experimentalElement,
  FhirDateTime date,
...
@JsonKey(unknownEnumValue: TestScriptOperationMethod.unknown) TestScriptOperationMethod method,
...
factory TestScriptAssert({
 ...
 String description,
  @JsonKey(name: '_description')  Element descriptionElement,
@JsonKey(unknownEnumValue: TestScriptAssertDirection.unknown) TestScriptAssertDirection direction,
...
@JsonKey(unknownEnumValue: TestScriptAssertOperator.unknown) TestScriptAssertOperator operator,
  @JsonKey(name: '_operator')  Element operatorElement,
 String path,
  @JsonKey(name: '_path')  Element pathElement,
@JsonKey(unknownEnumValue: TestScriptAssertRequestMethod.unknown) TestScriptAssertRequestMethod requestMethod,
  @JsonKey(name: '_requestMethod')  Element requestMethodElement,
 String requestURL,
  @JsonKey(name: '_requestURL')  Element requestURLElement,
 Code resource,
  @JsonKey(name: '_resource')  Element resourceElement,
@JsonKey(unknownEnumValue: TestScriptAssertResponse.unknown) TestScriptAssertResponse response,
