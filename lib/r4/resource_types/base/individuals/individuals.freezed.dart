...
class _$_GroupCharacteristic implements _GroupCharacteristic {
  ...
  @override
  String toString() {
    return 'GroupCharacteristic(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, code: $code, valueCodeableConcept: $valueCodeableConcept, valueBoolean: $valueBoolean, valueQuantity: $valueQuantity, valueRange: $valueRange, valueReference: $valueReference, exclude: $exclude, period: $period)';
  }
...
class _$_Practitioner implements _Practitioner {
  ...
  @override
  String toString() {
    return 'Practitioner(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, active: $active, name: $name, telecom: $telecom, address: $address, gender: $gender, birthDate: $birthDate, photo: $photo, qualification: $qualification, communication: $communication)';
  }
...
class _$_PractitionerRoleAvailableTime
  ...
  @override
  String toString() {
    return 'PractitionerRoleAvailableTime(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, daysOfWeek: $daysOfWeek, allDay: $allDay, availableStartTime: $availableStartTime, availableEndTime: $availableEndTime)';
  }
...
class _$_PractitionerRoleNotAvailable implements _PractitionerRoleNotAvailable {
  ...
  @override
  String toString() {
    return 'PractitionerRoleNotAvailable(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, description: $description, during: $during)';
  }
...
class _$_RelatedPerson implements _RelatedPerson {
  ...
  @override
  String toString() {
    return 'RelatedPerson(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, active: $active, patient: $patient, relationship: $relationship, name: $name, telecom: $telecom, gender: $gender, birthDate: $birthDate, address: $address, photo: $photo, period: $period, communication: $communication)';
  }
...
class _$_RelatedPersonCommunication implements _RelatedPersonCommunication {
  ...
  @override
  String toString() {
    return 'RelatedPersonCommunication(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, language: $language, preferred: $preferred)';
  }
...
abstract class _RelatedPersonCommunication
  ...
  const factory _RelatedPersonCommunication(
      ...
      List<FhirExtension> modifierExtension,
      @required @JsonKey(required: true) CodeableConcept language,
      Boolean preferred}) = _$_RelatedPersonCommunication;
