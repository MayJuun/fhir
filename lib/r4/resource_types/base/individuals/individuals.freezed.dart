...
class _$_Group implements _Group {
  ...
  @override
  String toString() {
    return 'Group(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, active: $active, type: $type, actual: $actual, code: $code, name: $name, quantity: $quantity, managingEntity: $managingEntity, characteristic: $characteristic, member: $member, implicitRulesElement: $implicitRulesElement, languageElement: $languageElement, activeElement: $activeElement, typeElement: $typeElement, actualElement: $actualElement, nameElement: $nameElement, quantityElement: $quantityElement)';
  }
...
class _$_GroupCharacteristic implements _GroupCharacteristic {
  ...
  @override
  String toString() {
    return 'GroupCharacteristic(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, code: $code, valueCodeableConcept: $valueCodeableConcept, valueBoolean: $valueBoolean, valueQuantity: $valueQuantity, valueRange: $valueRange, valueReference: $valueReference, exclude: $exclude, period: $period, valueBooleanElement: $valueBooleanElement, excludeElement: $excludeElement)';
  }
...
class _$PatientLinkTearOff {
  ...
  _PatientLink call(
      ...
      @JsonKey(name: 'extension') List<FhirExtension> extension_,
      List<FhirExtension> modifierExtension,
      @required @JsonKey(required: true) Reference other,
...
class _$_PatientLink implements _PatientLink {
  const _$_PatientLink(
      ...
      @JsonKey(name: 'extension') this.extension_,
      this.modifierExtension,
      @required @JsonKey(required: true) this.other,
      @JsonKey(unknownEnumValue: LinkType.unknown) this.type,
...
class _$_Practitioner implements _Practitioner {
  ...
  @override
  String toString() {
    return 'Practitioner(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, active: $active, name: $name, telecom: $telecom, address: $address, gender: $gender, birthDate: $birthDate, photo: $photo, qualification: $qualification, communication: $communication, implicitRulesElement: $implicitRulesElement, languageElement: $languageElement, activeElement: $activeElement, genderElement: $genderElement, birthDateElement: $birthDateElement)';
  }
...
class _$_PractitionerRoleNotAvailable implements _PractitionerRoleNotAvailable {
  ...
  @override
  String toString() {
    return 'PractitionerRoleNotAvailable(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, description: $description, during: $during, descriptionElement: $descriptionElement)';
  }
...
class _$_RelatedPerson implements _RelatedPerson {
  ...
  @override
  String toString() {
    return 'RelatedPerson(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, active: $active, patient: $patient, relationship: $relationship, name: $name, telecom: $telecom, gender: $gender, birthDate: $birthDate, address: $address, photo: $photo, period: $period, communication: $communication, implicitRulesElement: $implicitRulesElement, languageElement: $languageElement, activeElement: $activeElement, genderElement: $genderElement, birthDateElement: $birthDateElement)';
  }
        ...
        (other is _RelatedPerson &&
            ...
            (identical(other.genderElement, genderElement) ||
                const DeepCollectionEquality()
                    .equals(other.genderElement, genderElement)) &&
            (identical(other.birthDateElement, birthDateElement) ||
                const DeepCollectionEquality().equals(other.birthDateElement, birthDateElement)));
  }
