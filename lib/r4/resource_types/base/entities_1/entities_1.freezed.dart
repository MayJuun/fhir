...
mixin _$Entities1 {
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result healthcareServiceAvailableTime(
        ...
        Time availableStartTime,
        Time availableEndTime),
    Result healthcareServiceNotAvailable(String id, List<Extension> extension,
        List<Extension> modifierExtension, String description, Period during),
    Result location(
        String resourceType,
        Id id,
        Meta meta,
