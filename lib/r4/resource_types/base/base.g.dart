...
Map<String, dynamic> _$_$_BiologicallyDerivedProductStorageToJson(
  ...
  writeNotNull('scale', _$StorageScaleEnumMap[instance.scale]);
  writeNotNull('duration', instance.duration?.toJson());
  return val;
}

const _$StorageScaleEnumMap = {
  StorageScale.farenheit: 'farenheit',
  StorageScale.celsius: 'celsius',
  StorageScale.kelvin: 'kelvin',
  StorageScale.unknown: 'unknown',
};
...
_$_DeviceUdiCarrier _$_$_DeviceUdiCarrierFromJson(Map<String, dynamic> json) {
  return _$_DeviceUdiCarrier(
    ...
    entryType: _$enumDecodeNullable(
        _$UdiCarrierEntryTypeEnumMap, json['entryType'],
        unknownValue: UdiCarrierEntryType.unknown),
  );
}
...
Map<String, dynamic> _$_$_DeviceUdiCarrierToJson(_$_DeviceUdiCarrier instance) {
  ...
  writeNotNull('entryType', _$UdiCarrierEntryTypeEnumMap[instance.entryType]);
  return val;
}

const _$UdiCarrierEntryTypeEnumMap = {
  UdiCarrierEntryType.barcode: 'barcode',
  UdiCarrierEntryType.rfid: 'rfid',
  UdiCarrierEntryType.manual: 'manual',
  UdiCarrierEntryType.card: 'card',
  UdiCarrierEntryType.self_reported: 'self-reported',
  UdiCarrierEntryType.unknown: 'unknown',
};
...
_$_DeviceSpecialization _$_$_DeviceSpecializationFromJson(
    Map<String, dynamic> json) {
  $checkKeys(json, requiredKeys: const ['systemType']);
  ...
  return _$_EpisodeOfCareStatusHistory(
    ...
    modifierExtension: (json['modifierExtension'] as List)
        ?.map((e) => e == null
            ...
            : FhirExtension.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    status: _$enumDecodeNullable(_$StatusHistoryStatusEnumMap, json['status'],
        unknownValue: StatusHistoryStatus.unknown),
    period: json['period'] == null
        ? null
        : Period.fromJson(json['period'] as Map<String, dynamic>),
  );
...
Map<String, dynamic> _$_$_EpisodeOfCareStatusHistoryToJson(
  ...
  writeNotNull('modifierExtension',
      instance.modifierExtension?.map((e) => e?.toJson())?.toList());
  writeNotNull('status', _$StatusHistoryStatusEnumMap[instance.status]);
  writeNotNull('period', instance.period?.toJson());
  return val;
}

const _$StatusHistoryStatusEnumMap = {
  StatusHistoryStatus.planned: 'planned',
  StatusHistoryStatus.waitlist: 'waitlist',
  StatusHistoryStatus.active: 'active',
  StatusHistoryStatus.onhold: 'onhold',
  StatusHistoryStatus.finished: 'finished',
  StatusHistoryStatus.cancelled: 'cancelled',
  StatusHistoryStatus.entered_in_error: 'entered-in-error',
  StatusHistoryStatus.unknown: 'unknown',
};
