...
class _$AppointmentParticipant implements AppointmentParticipant {
  ...
  @override
  String toString() {
    return 'Workflow.appointmentParticipant(id: $id, extension: $extension, modifierExtension: $modifierExtension, type: $type, actor: $actor, required: $required, status: $status, period: $period)';
  }
  ...
  Result when<Result extends Object>({
    ...
    assert(verificationResultAttestation != null);
    assert(verificationResultValidator != null);
    return appointmentParticipant(id, extension, modifierExtension, type, actor,
