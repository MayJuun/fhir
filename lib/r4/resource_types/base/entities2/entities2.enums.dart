...
@JsonValue('organ')
organ,@JsonValue('tissue')
tissue,@JsonValue('fluid')
fluid,@JsonValue('cells')
cells,@JsonValue('biologicalAgent')
biologicalagent,@JsonValue('unknown')
  unknown,}
...
@JsonValue('farenheit')
farenheit,@JsonValue('celsius')
celsius,@JsonValue('kelvin')
kelvin,@JsonValue('unknown')
  unknown,}
