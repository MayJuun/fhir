...
class _$_CatalogEntry implements _CatalogEntry {
  ...
  @override
  String toString() {
    return 'CatalogEntry(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, type: $type, orderable: $orderable, referencedItem: $referencedItem, additionalIdentifier: $additionalIdentifier, classification: $classification, status: $status, validityPeriod: $validityPeriod, validTo: $validTo, lastUpdated: $lastUpdated, additionalCharacteristic: $additionalCharacteristic, additionalClassification: $additionalClassification, relatedEntry: $relatedEntry)';
  }
...
class _$_CatalogEntryRelatedEntry implements _CatalogEntryRelatedEntry {
  ...
  @override
  String toString() {
    return 'CatalogEntryRelatedEntry(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, relationtype: $relationtype, item: $item)';
  }
...
class _$_Composition implements _Composition {
  ...
  @override
  String toString() {
    return 'Composition(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, type: $type, category: $category, subject: $subject, encounter: $encounter, date: $date, author: $author, title: $title, confidentiality: $confidentiality, attester: $attester, custodian: $custodian, relatesTo: $relatesTo, event: $event, section: $section)';
  }
...
class _$_CompositionRelatesTo implements _CompositionRelatesTo {
  ...
  @override
  String toString() {
    return 'CompositionRelatesTo(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, code: $code, targetIdentifier: $targetIdentifier, targetReference: $targetReference)';
  }
...
class _$_CompositionSection implements _CompositionSection {
  ...
  @override
  String toString() {
    return 'CompositionSection(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, title: $title, code: $code, author: $author, focus: $focus, text: $text, mode: $mode, orderedBy: $orderedBy, emptyReason: $emptyReason, section: $section)';
  }
...
class _$_DocumentManifest implements _DocumentManifest {
  ...
  @override
  String toString() {
    return 'DocumentManifest(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, masterIdentifier: $masterIdentifier, identifier: $identifier, status: $status, type: $type, subject: $subject, created: $created, author: $author, recipient: $recipient, source: $source, content: $content, related: $related)';
  }
...
class _$_DocumentReference implements _DocumentReference {
  ...
  @override
  String toString() {
    return 'DocumentReference(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, masterIdentifier: $masterIdentifier, identifier: $identifier, status: $status, docStatus: $docStatus, type: $type, category: $category, subject: $subject, date: $date, author: $author, custodian: $custodian, relatesTo: $relatesTo, description: $description, securityLabel: $securityLabel, content: $content, context: $context)';
  }
...
class _$_DocumentReferenceContent implements _DocumentReferenceContent {
  ...
  @override
  String toString() {
    return 'DocumentReferenceContent(fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, attachment: $attachment, format: $format)';
  }
...
class _$_DocumentReferenceContext implements _DocumentReferenceContext {
  ...
  @override
  String toString() {
    return 'DocumentReferenceContext(id: $id, modifierExtension: $modifierExtension, encounter: $encounter, event: $event, period: $period, facilityType: $facilityType, practiceSetting: $practiceSetting, sourcePatientInfo: $sourcePatientInfo, related: $related)';
  }
