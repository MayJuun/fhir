...
complete,@JsonValue('supplement')
supplement,@JsonValue('unknown')
  unknown,}
...
datetime,@JsonValue('decimal')
decimal,@JsonValue('unknown')
  unknown,}
...
@JsonValue('explicit')
explicit,@JsonValue('all')
all,@JsonValue('unknown')
  unknown,}
