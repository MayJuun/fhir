...
class _$_AuditEvent implements _AuditEvent {
  ...
  @override
  String toString() {
    return 'AuditEvent(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, subtype: $subtype, action: $action, period: $period, recorded: $recorded, outcome: $outcome, outcomeDesc: $outcomeDesc, purposeOfEvent: $purposeOfEvent, agent: $agent, source: $source, entity: $entity)';
  }
...
class _$_AuditEventAgent implements _AuditEventAgent {
  ...
  @override
  String toString() {
    return 'AuditEventAgent(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, role: $role, who: $who, altId: $altId, name: $name, requestor: $requestor, location: $location, policy: $policy, media: $media, network: $network, purposeOfUse: $purposeOfUse)';
  }
...
class _$_AuditEventNetwork implements _AuditEventNetwork {
  ...
  @override
  String toString() {
    return 'AuditEventNetwork(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, address: $address, type: $type)';
  }
...
abstract class _AuditEventNetwork implements AuditEventNetwork {
  const factory _AuditEventNetwork(
      ...
      List<FhirExtension> modifierExtension,
      String address,
      AuditEventNetworkType type}) = _$_AuditEventNetwork;
...
class _$_AuditEventSource implements _AuditEventSource {
  ...
  @override
  String toString() {
    return 'AuditEventSource(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, site: $site, observer: $observer, type: $type)';
  }
...
class _$_AuditEventEntity implements _AuditEventEntity {
  ...
  @override
  String toString() {
    return 'AuditEventEntity(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, what: $what, type: $type, role: $role, lifecycle: $lifecycle, securityLabel: $securityLabel, name: $name, description: $description, query: $query, detail: $detail)';
  }
...
class _$_AuditEventDetail implements _AuditEventDetail {
  ...
  @override
  String toString() {
    return 'AuditEventDetail(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, valueString: $valueString, valueBase64Binary: $valueBase64Binary)';
  }
...
class _$_Consent implements _Consent {
  ...
  @override
  String toString() {
    return 'Consent(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, scope: $scope, category: $category, patient: $patient, dateTime: $dateTime, performer: $performer, organization: $organization, sourceAttachment: $sourceAttachment, sourceReference: $sourceReference, policy: $policy, policyRule: $policyRule, verification: $verification, provision: $provision)';
  }
...
class _$_ConsentPolicy implements _ConsentPolicy {
  ...
  @override
  String toString() {
    return 'ConsentPolicy(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, authority: $authority, uri: $uri)';
  }
...
class _$_ConsentVerification implements _ConsentVerification {
  ...
  @override
  String toString() {
    return 'ConsentVerification(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, verified: $verified, verifiedWith: $verifiedWith, verificationDate: $verificationDate)';
  }
...
class _$_ConsentProvision implements _ConsentProvision {
  ...
  @override
  String toString() {
    return 'ConsentProvision(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, period: $period, actor: $actor, action: $action, securityLabel: $securityLabel, purpose: $purpose, clas: $clas, code: $code, dataPeriod: $dataPeriod, data: $data, provision: $provision)';
  }
...
class _$_ConsentActor implements _ConsentActor {
  ...
  @override
  String toString() {
    return 'ConsentActor(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, role: $role, reference: $reference)';
  }
...
class _$_ConsentData implements _ConsentData {
  ...
  @override
  String toString() {
    return 'ConsentData(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, meaning: $meaning, reference: $reference)';
  }
...
class _$_Provenance implements _Provenance {
  ...
  @override
  String toString() {
    return 'Provenance(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, target: $target, occurredPeriod: $occurredPeriod, occurredDateTime: $occurredDateTime, recorded: $recorded, policy: $policy, location: $location, reason: $reason, activity: $activity, agent: $agent, entity: $entity, signature: $signature)';
  }
...
class _$_ProvenanceAgent implements _ProvenanceAgent {
  ...
  @override
  String toString() {
    return 'ProvenanceAgent(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, role: $role, who: $who, onBehalfOf: $onBehalfOf)';
  }
...
class _$_ProvenanceEntity implements _ProvenanceEntity {
  ...
  @override
  String toString() {
    return 'ProvenanceEntity(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, role: $role, what: $what, agent: $agent)';
  }
