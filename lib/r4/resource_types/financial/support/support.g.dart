...
_$_CoverageEligibilityRequest _$_$_CoverageEligibilityRequestFromJson(
  ...
  return _$_CoverageEligibilityRequest(
    ...
    purpose: (json['purpose'] as List)
        ?.map((e) => _$enumDecodeNullable(_$RequestResponsePurposeEnumMap, e))
        ?.toList(),
...
Map<String, dynamic> _$_$_CoverageEligibilityRequestToJson(
  ...
  writeNotNull(
      'purpose',
      instance.purpose
          ?.map((e) => _$RequestResponsePurposeEnumMap[e])
          ?.toList());
...
const _$RequestResponsePurposeEnumMap = {
  RequestResponsePurpose.auth_requirements: 'auth-requirements',
  RequestResponsePurpose.benefits: 'benefits',
  RequestResponsePurpose.discovery: 'discovery',
  RequestResponsePurpose.validation: 'validation',
  RequestResponsePurpose.unknown: 'unknown',
};
