...
class _$_Coverage implements _Coverage {
  ...
  @override
  String toString() {
    return 'Coverage(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, type: $type, policyHolder: $policyHolder, subscriber: $subscriber, subscriberId: $subscriberId, beneficiary: $beneficiary, dependent: $dependent, relationship: $relationship, period: $period, payor: $payor, class_: $class_, order: $order, network: $network, costToBeneficiary: $costToBeneficiary, subrogation: $subrogation, contract: $contract)';
  }
...
class _$_CoverageClass implements _CoverageClass {
  ...
  @override
  String toString() {
    return 'CoverageClass(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, type: $type, value: $value, name: $name)';
  }
...
class _$_CoverageEligibilityRequestSupportingInfo
  ...
  @override
  String toString() {
    return 'CoverageEligibilityRequestSupportingInfo(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, information: $information, appliesToAll: $appliesToAll)';
  }
...
abstract class _CoverageEligibilityRequestSupportingInfo
  ...
  const factory _CoverageEligibilityRequestSupportingInfo(
      ...
      PositiveInt sequence,
      @required @JsonKey(required: true) Reference information,
      Boolean appliesToAll}) = _$_CoverageEligibilityRequestSupportingInfo;
...
class _$_CoverageEligibilityRequestInsurance
  ...
  @override
  String toString() {
    return 'CoverageEligibilityRequestInsurance(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, focal: $focal, coverage: $coverage, businessArrangement: $businessArrangement)';
  }
...
class _$_CoverageEligibilityResponse implements _CoverageEligibilityResponse {
  ...
  @override
  String toString() {
    return 'CoverageEligibilityResponse(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, purpose: $purpose, patient: $patient, servicedDate: $servicedDate, servicedPeriod: $servicedPeriod, created: $created, requestor: $requestor, request: $request, outcome: $outcome, disposition: $disposition, insurer: $insurer, insurance: $insurance, preAuthRef: $preAuthRef, form: $form, error: $error)';
  }
...
class _$_CoverageEligibilityResponseInsurance
  ...
  @override
  String toString() {
    return 'CoverageEligibilityResponseInsurance(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, coverage: $coverage, inforce: $inforce, benefitPeriod: $benefitPeriod, item: $item)';
  }
...
class _$_CoverageEligibilityResponseBenefit
  ...
  @override
  String toString() {
    return 'CoverageEligibilityResponseBenefit(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, type: $type, allowedUnsignedInt: $allowedUnsignedInt, allowedString: $allowedString, allowedMoney: $allowedMoney, usedUnsignedInt: $usedUnsignedInt, usedString: $usedString, usedMoney: $usedMoney)';
  }
