...
mixin _$CoverageEligibilityRequest {
  ...
  List<Identifier> get identifier;
  @JsonKey(unknownEnumValue: CoverageEligibilityRequestStatus.unknown)
  CoverageEligibilityRequestStatus get status;
...
class _$CoverageEligibilityRequestCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      status: status == freezed
          ? _value.status
          : status as CoverageEligibilityRequestStatus,
      priority:
...
class _$_CoverageEligibilityRequest implements _CoverageEligibilityRequest {
  ...
  @override
  @JsonKey(unknownEnumValue: CoverageEligibilityRequestStatus.unknown)
  final CoverageEligibilityRequestStatus status;
  @override
...
mixin _$Coverage {
  ...
  List<FhirExtension> get modifierExtension;
  List<Identifier> get identifier;
  @JsonKey(unknownEnumValue: CoverageStatus.unknown)
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      identifier: identifier == freezed
          ? _value.identifier
          : identifier as List<Identifier>,
      status: status == freezed ? _value.status : status as CoverageStatus,
      type: type == freezed ? _value.type : type as CodeableConcept,
...
class _$_Coverage implements _Coverage {
  const _$_Coverage(
      ...
      this.modifierExtension,
      this.identifier,
      @JsonKey(unknownEnumValue: CoverageStatus.unknown) this.status,
      this.type,
      this.policyHolder,
      this.subscriber,
      this.subscriberId,
