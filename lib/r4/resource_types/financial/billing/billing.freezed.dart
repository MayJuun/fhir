...
class _$_ClaimCareTeam implements _ClaimCareTeam {
  ...
  @override
  String toString() {
    return 'ClaimCareTeam(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, provider: $provider, responsible: $responsible, role: $role, qualification: $qualification)';
  }
...
class _$_ClaimDiagnosis implements _ClaimDiagnosis {
  ...
  @override
  String toString() {
    return 'ClaimDiagnosis(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, diagnosisCodeableConcept: $diagnosisCodeableConcept, diagnosisReference: $diagnosisReference, type: $type, onAdmission: $onAdmission, packageCode: $packageCode)';
  }
...
class _$_ClaimProcedure implements _ClaimProcedure {
  ...
  @override
  String toString() {
    return 'ClaimProcedure(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, type: $type, date: $date, procedureCodeableConcept: $procedureCodeableConcept, procedureReference: $procedureReference, udi: $udi)';
  }
...
class _$_ClaimInsurance implements _ClaimInsurance {
  ...
  @override
  String toString() {
    return 'ClaimInsurance(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, focal: $focal, identifier: $identifier, coverage: $coverage, businessArrangement: $businessArrangement, preAuthRef: $preAuthRef, claimResponse: $claimResponse)';
  }
...
class _$_ClaimAccident implements _ClaimAccident {
  ...
  @override
  String toString() {
    return 'ClaimAccident(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, date: $date, type: $type, locationAddress: $locationAddress, locationReference: $locationReference)';
  }
...
class _$_ClaimDetail implements _ClaimDetail {
  ...
  @override
  String toString() {
    return 'ClaimDetail(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, revenue: $revenue, category: $category, productOrService: $productOrService, modifier: $modifier, programCode: $programCode, quantity: $quantity, unitPrice: $unitPrice, factor: $factor, net: $net, udi: $udi, subDetail: $subDetail)';
  }
...
class _$_ClaimSubDetail implements _ClaimSubDetail {
  ...
  @override
  String toString() {
    return 'ClaimSubDetail(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, revenue: $revenue, category: $category, productOrService: $productOrService, modifier: $modifier, programCode: $programCode, quantity: $quantity, unitPrice: $unitPrice, factor: $factor, net: $net, udi: $udi)';
  }
...
class _$_ClaimResponseItem implements _ClaimResponseItem {
  ...
  @override
  String toString() {
    return 'ClaimResponseItem(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, itemSequence: $itemSequence, noteNumber: $noteNumber, adjudication: $adjudication, detail: $detail)';
  }
...
class _$_ClaimResponseAdjudication implements _ClaimResponseAdjudication {
  ...
  @override
  String toString() {
    return 'ClaimResponseAdjudication(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, category: $category, reason: $reason, amount: $amount, value: $value)';
  }
...
class _$_ClaimResponseDetail implements _ClaimResponseDetail {
  ...
  @override
  String toString() {
    return 'ClaimResponseDetail(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, detailSequence: $detailSequence, noteNumber: $noteNumber, adjudication: $adjudication, subDetail: $subDetail)';
  }
...
class _$_ClaimResponseSubDetail implements _ClaimResponseSubDetail {
  ...
  @override
  String toString() {
    return 'ClaimResponseSubDetail(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, subDetailSequence: $subDetailSequence, noteNumber: $noteNumber, adjudication: $adjudication)';
  }
...
class _$_ClaimResponseDetail1 implements _ClaimResponseDetail1 {
  ...
  @override
  String toString() {
    return 'ClaimResponseDetail1(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, productOrService: $productOrService, modifier: $modifier, quantity: $quantity, unitPrice: $unitPrice, factor: $factor, net: $net, noteNumber: $noteNumber, adjudication: $adjudication, subDetail: $subDetail)';
  }
...
class _$_ClaimResponseSubDetail1 implements _ClaimResponseSubDetail1 {
  ...
  @override
  String toString() {
    return 'ClaimResponseSubDetail1(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, productOrService: $productOrService, modifier: $modifier, quantity: $quantity, unitPrice: $unitPrice, factor: $factor, net: $net, noteNumber: $noteNumber, adjudication: $adjudication)';
  }
...
class _$_ClaimResponsePayment implements _ClaimResponsePayment {
  ...
  @override
  String toString() {
    return 'ClaimResponsePayment(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, type: $type, adjustment: $adjustment, adjustmentReason: $adjustmentReason, date: $date, amount: $amount, identifier: $identifier)';
  }
...
class _$_ClaimResponseProcessNote implements _ClaimResponseProcessNote {
  ...
  @override
  String toString() {
    return 'ClaimResponseProcessNote(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, number: $number, type: $type, text: $text, language: $language)';
  }
...
class _$_ClaimResponseInsurance implements _ClaimResponseInsurance {
  ...
  @override
  String toString() {
    return 'ClaimResponseInsurance(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, focal: $focal, coverage: $coverage, businessArrangement: $businessArrangement, claimResponse: $claimResponse)';
  }
...
class _$_Invoice implements _Invoice {
  ...
  @override
  String toString() {
    return 'Invoice(resourceType: $resourceType, id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, extension_: $extension_, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, cancelledReason: $cancelledReason, type: $type, subject: $subject, recipient: $recipient, date: $date, participant: $participant, issuer: $issuer, account: $account, lineItem: $lineItem, totalPriceComponent: $totalPriceComponent, totalNet: $totalNet, totalGross: $totalGross, paymentTerms: $paymentTerms, note: $note)';
  }
...
class _$_InvoiceLineItem implements _InvoiceLineItem {
  ...
  @override
  String toString() {
    return 'InvoiceLineItem(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, sequence: $sequence, chargeItemReference: $chargeItemReference, chargeItemCodeableConcept: $chargeItemCodeableConcept, priceComponent: $priceComponent)';
  }
...
class _$_InvoicePriceComponent implements _InvoicePriceComponent {
  ...
  @override
  String toString() {
    return 'InvoicePriceComponent(id: $id, extension_: $extension_, modifierExtension: $modifierExtension, type: $type, code: $code, factor: $factor, amount: $amount)';
  }
