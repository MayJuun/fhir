...
class _$_ProcessRequest implements _ProcessRequest {
  ...
  @override
  String toString() {
    return 'ProcessRequest(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, action: $action, identifier: $identifier, ruleset: $ruleset, originalRuleset: $originalRuleset, created: $created, target: $target, provider: $provider, organization: $organization, request: $request, response: $response, nullify: $nullify, reference: $reference, item: $item, include: $include, exclude: $exclude, period: $period)';
  }
...
class _$_ProcessRequestItem implements _ProcessRequestItem {
  ...
  @override
  String toString() {
    return 'ProcessRequestItem(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, sequenceLinkId: $sequenceLinkId)';
  }
...
abstract class _ProcessRequestItem implements ProcessRequestItem {
  factory _ProcessRequestItem(
      ...
      @JsonKey(name: 'extension') List<FhirExtension> fhirExtension,
      List<FhirExtension> modifierExtension,
      Integer sequenceLinkId}) = _$_ProcessRequestItem;
...
class _$_ProcessResponse implements _ProcessResponse {
  ...
  @override
  String toString() {
    return 'ProcessResponse(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, request: $request, outcome: $outcome, disposition: $disposition, ruleset: $ruleset, originalRuleset: $originalRuleset, created: $created, organization: $organization, requestProvider: $requestProvider, requestOrganization: $requestOrganization, form: $form, notes: $notes, error: $error)';
  }
...
class _$_ProcessResponseNotes implements _ProcessResponseNotes {
  ...
  @override
  String toString() {
    return 'ProcessResponseNotes(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, text: $text)';
  }
...
class _$_SupplyDelivery implements _SupplyDelivery {
  ...
  @override
  String toString() {
    return 'SupplyDelivery(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, patient: $patient, type: $type, quantity: $quantity, suppliedItem: $suppliedItem, supplier: $supplier, whenPrepared: $whenPrepared, time: $time, destination: $destination, receiver: $receiver)';
  }
...
class _$_SupplyRequest implements _SupplyRequest {
  ...
  @override
  String toString() {
    return 'SupplyRequest(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, patient: $patient, source: $source, date: $date, identifier: $identifier, status: $status, kind: $kind, orderedItem: $orderedItem, supplier: $supplier, reasonX: $reasonX, when: $when)';
  }
...
class _$_SupplyRequestWhen implements _SupplyRequestWhen {
  ...
  @override
  String toString() {
    return 'SupplyRequestWhen(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, code: $code, schedule: $schedule)';
  }
