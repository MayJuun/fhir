...
class _$_Appointment implements _Appointment {
  ...
  @override
  String toString() {
    return 'Appointment(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, status: $status, type: $type, reason: $reason, priority: $priority, description: $description, start: $start, end: $end, minutesDuration: $minutesDuration, slot: $slot, comment: $comment, participant: $participant)';
  }
...
class _$AppointmentParticipantCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      required: required == freezed ? _value.required : required as Code,
      status: status == freezed ? _value.status : status as Code,
    ));
  }
...
class _$_AppointmentParticipant implements _AppointmentParticipant {
  ...
  @override
  String toString() {
    return 'AppointmentParticipant(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, actor: $actor, required: $required, status: $status)';
  }
...
abstract class _AppointmentParticipant implements AppointmentParticipant {
  factory _AppointmentParticipant(
      ...
      Reference actor,
      Code required,
      Code status}) = _$_AppointmentParticipant;
...
class _$_AppointmentResponse implements _AppointmentResponse {
  ...
  @override
  String toString() {
    return 'AppointmentResponse(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, appointment: $appointment, start: $start, end: $end, participantType: $participantType, actor: $actor, participantStatus: $participantStatus, comment: $comment)';
  }
...
class _$_Schedule implements _Schedule {
  ...
  @override
  String toString() {
    return 'Schedule(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, type: $type, actor: $actor, planningHorizon: $planningHorizon, comment: $comment)';
  }
...
class _$SlotCopyWithImpl<$Res> implements $SlotCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      freeBusyType:
          freeBusyType == freezed ? _value.freeBusyType : freeBusyType as Code,
      start: start == freezed ? _value.start : start as Instant,
      end: end == freezed ? _value.end : end as Instant,
      overbooked:
...
class _$_Slot implements _Slot {
  ...
  @override
  String toString() {
    return 'Slot(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, type: $type, schedule: $schedule, freeBusyType: $freeBusyType, start: $start, end: $end, overbooked: $overbooked, comment: $comment)';
  }
