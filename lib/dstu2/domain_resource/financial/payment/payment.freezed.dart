...
class _$_PaymentNotice implements _PaymentNotice {
  ...
  @override
  String toString() {
    return 'PaymentNotice(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, ruleset: $ruleset, originalRuleset: $originalRuleset, created: $created, target: $target, provider: $provider, organization: $organization, request: $request, response: $response, paymentStatus: $paymentStatus)';
  }
...
class _$_PaymentReconciliation implements _PaymentReconciliation {
  ...
  @override
  String toString() {
    return 'PaymentReconciliation(id: $id, meta: $meta, implicitRules: $implicitRules, language: $language, text: $text, contained: $contained, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, identifier: $identifier, request: $request, outcome: $outcome, disposition: $disposition, ruleset: $ruleset, originalRuleset: $originalRuleset, created: $created, period: $period, organization: $organization, requestProvider: $requestProvider, requestOrganization: $requestOrganization, detail: $detail, form: $form, total: $total, note: $note)';
  }
...
class _$_PaymentReconciliationDetail implements _PaymentReconciliationDetail {
  ...
  @override
  String toString() {
    return 'PaymentReconciliationDetail(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, request: $request, responce: $responce, submitter: $submitter, payee: $payee, date: $date, amount: $amount)';
  }
...
class _$_PaymentReconciliationNote implements _PaymentReconciliationNote {
  ...
  @override
  String toString() {
    return 'PaymentReconciliationNote(id: $id, fhirExtension: $fhirExtension, modifierExtension: $modifierExtension, type: $type, text: $text)';
  }
