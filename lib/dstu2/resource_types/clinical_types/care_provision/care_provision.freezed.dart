...
class _$VisionPrescriptionCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      reasonX: reasonX == freezed ? _value.reasonX : reasonX as CodeableConcept,
      dispense:
          dispense == freezed ? _value.dispense : dispense as BackboneElement,
    ));
  }
}
...
class _$_VisionPrescription implements _VisionPrescription {
  ...
  final CodeableConcept reasonX;
  @override
  final BackboneElement dispense;
...
abstract class _VisionPrescription implements VisionPrescription {
  const factory _VisionPrescription(
      ...
      Reference encounter,
      CodeableConcept reasonX,
      BackboneElement dispense}) = _$_VisionPrescription;
...
mixin _$CarePlan {
  ...
  BackboneElement get relatedPlan;
  BackboneElement get participant;
  Reference get goal;
  BackboneElement get activity;
  Annotation get note;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      relatedPlan: relatedPlan == freezed
          ? _value.relatedPlan
          : relatedPlan as BackboneElement,
      participant: participant == freezed
          ? _value.participant
          : participant as BackboneElement,
      goal: goal == freezed ? _value.goal : goal as Reference,
      activity:
          activity == freezed ? _value.activity : activity as BackboneElement,
...
class _$_CarePlan implements _CarePlan {
  ...
  @override
  final BackboneElement relatedPlan;
  @override
  final BackboneElement participant;
  @override
  final Reference goal;
  @override
  final BackboneElement activity;
  @override
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      addresses:
          addresses == freezed ? _value.addresses : addresses as Reference,
      note: note == freezed ? _value.note : note as Annotation,
      outcome: outcome == freezed ? _value.outcome : outcome as BackboneElement,
    ));
  }
}
...
abstract class _Goal implements Goal {
  const factory _Goal(
      ...
      Reference addresses,
      Annotation note,
      BackboneElement outcome}) = _$_Goal;
...
mixin _$NutritionOrder {
  ...
  BackboneElement get oralDiet;
  BackboneElement get supplement;
  BackboneElement get enteralFormula;
...
class _$NutritionOrderCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      oralDiet:
          oralDiet == freezed ? _value.oralDiet : oralDiet as BackboneElement,
      supplement: supplement == freezed
          ? _value.supplement
          : supplement as BackboneElement,
      enteralFormula: enteralFormula == freezed
          ? _value.enteralFormula
          : enteralFormula as BackboneElement,
    ));
  }
}
...
class _$_NutritionOrder implements _NutritionOrder {
  ...
  @override
  final BackboneElement supplement;
  @override
...
abstract class _NutritionOrder implements NutritionOrder {
  const factory _NutritionOrder(
      ...
      BackboneElement oralDiet,
      BackboneElement supplement,
      BackboneElement enteralFormula}) = _$_NutritionOrder;
...
abstract class _CarePlanActivity implements CarePlanActivity {
  const factory _CarePlanActivity(
      ...
      Annotation progress,
      Reference reference,
      BackboneElement detail}) = _$_CarePlanActivity;
...
class _$_GoalOutcome implements _GoalOutcome {
  const _$_GoalOutcome(
      {this.id, this.extension_, this.modifierExtension, this.resultX});
...
mixin _$NutritionOrderOralDiet {
  ...
  CodeableConcept get type;
  Timing get schedule;
  BackboneElement get nutrient;
  BackboneElement get texture;
...
class _$NutritionOrderOralDietCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      nutrient:
          nutrient == freezed ? _value.nutrient : nutrient as BackboneElement,
      texture: texture == freezed ? _value.texture : texture as BackboneElement,
...
class _$_NutritionOrderOralDiet implements _NutritionOrderOralDiet {
  ...
  @override
  final BackboneElement nutrient;
  @override
  final BackboneElement texture;
  @override
...
mixin _$NutritionOrderEnteralFormula {
  ...
  BackboneElement get administration;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      administration: administration == freezed
          ...
          : administration as BackboneElement,
...
class _$_NutritionOrderEnteralFormula implements _NutritionOrderEnteralFormula {
  ...
  @override
  final BackboneElement administration;
  @override
