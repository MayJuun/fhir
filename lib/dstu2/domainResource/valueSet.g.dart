...
Map<String, dynamic> _$ValueSetCodeSystemConceptDesignationToJson(
    ValueSetCodeSystemConceptDesignation instance) {
  final val = <String, dynamic>{};
...
Map<String, dynamic> _$ValueSetComposeIncludeConceptToJson(
    ValueSetComposeIncludeConcept instance) {
  final val = <String, dynamic>{};
...
Map<String, dynamic> _$ValueSetComposeIncludeFilterToJson(
    ValueSetComposeIncludeFilter instance) {
  final val = <String, dynamic>{};
