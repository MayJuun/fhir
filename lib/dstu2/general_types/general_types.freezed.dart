...
class _$PeriodTearOff {
  ...
  _Period call(
      {Id id, FhirExtension extension_, FhirDateTime start, FhirDateTime end}) {
    return _Period(
      id: id,
...
class _$_Period implements _Period {
  const _$_Period({this.id, this.extension_, this.start, this.end});
...
class _$RangeTearOff {
  ...
  _Range call({Id id, FhirExtension extension_, Quantity low, Quantity high}) {
    return _Range(
      id: id,
      extension_: extension_,
      low: low,
...
abstract class $RangeCopyWith<$Res> {
  ...
  $Res call({Id id, FhirExtension extension_, Quantity low, Quantity high});
...
class _$_Range implements _Range {
  const _$_Range({this.id, this.extension_, this.low, this.high});
...
class _$_Ratio implements _Ratio {
  const _$_Ratio({this.id, this.extension_, this.numerator, this.denominator});
...
class _$CodeableConceptTearOff {
  ...
  _CodeableConcept call(
      {Id id, FhirExtension extension_, Coding coding, String text}) {
...
abstract class $CodeableConceptCopyWith<$Res> {
  ...
  $Res call({Id id, FhirExtension extension_, Coding coding, String text});
...
class _$CodeableConceptCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      extension_: extension_ == freezed
          ? _value.extension_
          : extension_ as FhirExtension,
      coding: coding == freezed ? _value.coding : coding as Coding,
      text: text == freezed ? _value.text : text as String,
    ));
  }
  ...
  $CodingCopyWith<$Res> get coding {
    ...
    return $CodingCopyWith<$Res>(_value.coding, (value) {
      return _then(_value.copyWith(coding: value));
    });
  }
}
...
class _$_CodeableConcept implements _CodeableConcept {
  const _$_CodeableConcept({this.id, this.extension_, this.coding, this.text});
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      extension_: extension_ == freezed
          ? _value.extension_
          : extension_ as FhirExtension,
      event: event == freezed ? _value.event : event as FhirDateTime,
...
class _$_Timing implements _Timing {
  const _$_Timing(
      {this.id, this.extension_, this.event, this.repeat, this.code});
...
class _$HumanNameCopyWithImpl<$Res> implements $HumanNameCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      given: given == freezed ? _value.given : given as String,
      prefix: prefix == freezed ? _value.prefix : prefix as String,
      suffix: suffix == freezed ? _value.suffix : suffix as String,
      period: period == freezed ? _value.period : period as Period,
    ));
  }
