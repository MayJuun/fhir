...
Map<String, dynamic> _$MedicinalProductNameToJson(
    MedicinalProductName instance) {
  final val = <String, dynamic>{};
...
Map<String, dynamic> _$MedicinalProductNamePartToJson(
    MedicinalProductNamePart instance) {
  final val = <String, dynamic>{};
...
Map<String, dynamic> _$MedicinalProductCountryLanguageToJson(
    MedicinalProductCountryLanguage instance) {
  final val = <String, dynamic>{};
...
Map<String, dynamic> _$MedicinalProductManufacturingBusinessOperationToJson(
    MedicinalProductManufacturingBusinessOperation instance) {
  final val = <String, dynamic>{};
...
Map<String, dynamic> _$MedicinalProductSpecialDesignationToJson(
    MedicinalProductSpecialDesignation instance) {
  final val = <String, dynamic>{};
