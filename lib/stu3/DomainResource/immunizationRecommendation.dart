...
factory ImmunizationRecommendation_Protocol.fromJson(Map<String, dynamic> json) => _$ImmunizationRecommendation_ProtocolFromJson(json);
Map<String, dynamic> toJson() => _$ImmunizationRecommendation_ProtocolToJson(this);
}