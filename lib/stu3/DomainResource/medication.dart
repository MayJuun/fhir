...
factory Medication_Package.fromJson(Map<String, dynamic> json) => _$Medication_PackageFromJson(json);
...
factory Medication_Content.fromJson(Map<String, dynamic> json) => _$Medication_ContentFromJson(json);
