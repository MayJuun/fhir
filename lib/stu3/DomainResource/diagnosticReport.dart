...
factory DiagnosticReport_Performer.fromJson(Map<String, dynamic> json) => _$DiagnosticReport_PerformerFromJson(json);
...
factory DiagnosticReport_Image.fromJson(Map<String, dynamic> json) => _$DiagnosticReport_ImageFromJson(json);
