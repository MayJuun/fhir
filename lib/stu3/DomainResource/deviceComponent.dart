...
factory DeviceComponent_ProductionSpecification.fromJson(Map<String, dynamic> json) => _$DeviceComponent_ProductionSpecificationFromJson(json);
Map<String, dynamic> toJson() => _$DeviceComponent_ProductionSpecificationToJson(this);
}