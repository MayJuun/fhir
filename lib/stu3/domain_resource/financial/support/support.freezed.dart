...
class _$_EnrollmentRequest implements _EnrollmentRequest {
  ...
  @override
  String toString() {
    return 'EnrollmentRequest(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, created: $created, insurer: $insurer, provider: $provider, organization: $organization, subject: $subject, coverage: $coverage)';
  }
...
class _$_EnrollmentResponse implements _EnrollmentResponse {
  ...
  @override
  String toString() {
    return 'EnrollmentResponse(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, request: $request, outcome: $outcome, disposition: $disposition, created: $created, organization: $organization, requestProvider: $requestProvider, requestOrganization: $requestOrganization)';
  }
...
class _$CoverageCopyWithImpl<$Res> implements $CoverageCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      order: order == freezed ? _value.order : order as double,
...
class _$_Coverage implements _Coverage {
  ...
  @override
  String toString() {
    return 'Coverage(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, type: $type, policyHolder: $policyHolder, subscriber: $subscriber, subscriberId: $subscriberId, beneficiary: $beneficiary, relationship: $relationship, period: $period, payor: $payor, grouping: $grouping, dependent: $dependent, sequence: $sequence, order: $order, network: $network, contract: $contract)';
  }
...
class _$CoverageGroupingCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      clas: clas == freezed ? _value.clas : clas as String,
...
class _$_CoverageGrouping implements _CoverageGrouping {
  ...
  @override
  String toString() {
    return 'CoverageGrouping(group: $group, groupDisplay: $groupDisplay, subGroup: $subGroup, subGroupDisplay: $subGroupDisplay, plan: $plan, planDisplay: $planDisplay, subPlan: $subPlan, subPlanDisplay: $subPlanDisplay, clas: $clas, classDisplay: $classDisplay, subClass: $subClass, subClassDisplay: $subClassDisplay)';
  }
...
class _$_EligibilityResponse implements _EligibilityResponse {
  ...
  @override
  String toString() {
    return 'EligibilityResponse(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, created: $created, requestProvider: $requestProvider, requestOrganization: $requestOrganization, request: $request, outcome: $outcome, disposition: $disposition, insurer: $insurer, inforce: $inforce, insurance: $insurance, form: $form, error: $error)';
  }
...
class _$EligibilityResponseErrorTearOff {
  ...
  _EligibilityResponseError call({CodeableConcept code}) {
...
class _$_EligibilityResponseError implements _EligibilityResponseError {
  _$_EligibilityResponseError({this.code});
...
abstract class _EligibilityResponseError implements EligibilityResponseError {
  factory _EligibilityResponseError({CodeableConcept code}) =
...
class _$_EligibilityRequest implements _EligibilityRequest {
  ...
  @override
  String toString() {
    return 'EligibilityRequest(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, priority: $priority, patient: $patient, servicedDate: $servicedDate, servicedPeriod: $servicedPeriod, created: $created, enterer: $enterer, provider: $provider, organization: $organization, insurer: $insurer, facility: $facility, coverage: $coverage, businessArrangement: $businessArrangement, benefitCategory: $benefitCategory, benefitSubCategory: $benefitSubCategory)';
  }
