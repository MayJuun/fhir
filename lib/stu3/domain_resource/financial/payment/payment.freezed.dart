...
class _$_PaymentReconciliation implements _PaymentReconciliation {
  ...
  @override
  String toString() {
    return 'PaymentReconciliation(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, period: $period, created: $created, organization: $organization, request: $request, outcome: $outcome, disposition: $disposition, requestProvider: $requestProvider, requestOrganization: $requestOrganization, detail: $detail, form: $form, total: $total, processNote: $processNote)';
  }
...
class _$_PaymentReconciliationProcessNote
  ...
  _$_PaymentReconciliationProcessNote({this.type, this.text});
...
class _$_PaymentNotice implements _PaymentNotice {
  ...
  @override
  String toString() {
    return 'PaymentNotice(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, request: $request, response: $response, statusDate: $statusDate, created: $created, target: $target, provider: $provider, organization: $organization, paymentStatus: $paymentStatus)';
  }
