...
class _$_DocumentReference implements _DocumentReference {
  ...
  @override
  String toString() {
    return 'DocumentReference(id: $id, resourceType: $resourceType, masterIdentifier: $masterIdentifier, identifier: $identifier, status: $status, docStatus: $docStatus, type: $type, clas: $clas, subject: $subject, created: $created, indexed: $indexed, author: $author, authenticator: $authenticator, custodian: $custodian, relatesTo: $relatesTo, description: $description, securityLabel: $securityLabel, content: $content, context: $context)';
  }
...
class _$DocumentReferenceRelatesToTearOff {
  ...
  _DocumentReferenceRelatesTo call({String code, Reference target}) {
...
abstract class $DocumentReferenceRelatesToCopyWith<$Res> {
  ...
  $Res call({String code, Reference target});
...
class _$_DocumentReferenceRelatesTo implements _DocumentReferenceRelatesTo {
  _$_DocumentReferenceRelatesTo({this.code, this.target});
...
abstract class _DocumentReferenceRelatesTo
  ...
  factory _DocumentReferenceRelatesTo({String code, Reference target}) =
...
class _$DocumentReferenceContentTearOff {
  ...
  _DocumentReferenceContent call({Attachment attachment, Coding format}) {
...
class _$_DocumentReferenceContent implements _DocumentReferenceContent {
  _$_DocumentReferenceContent({this.attachment, this.format});
...
abstract class _DocumentReferenceContent implements DocumentReferenceContent {
  factory _DocumentReferenceContent({Attachment attachment, Coding format}) =
...
class _$_DocumentManifest implements _DocumentManifest {
  ...
  @override
  String toString() {
    return 'DocumentManifest(id: $id, resourceType: $resourceType, masterIdentifier: $masterIdentifier, identifier: $identifier, status: $status, type: $type, subject: $subject, created: $created, author: $author, recipient: $recipient, source: $source, description: $description, content: $content, related: $related)';
  }
...
class _$_Composition implements _Composition {
  ...
  @override
  String toString() {
    return 'Composition(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, type: $type, clas: $clas, subject: $subject, encounter: $encounter, date: $date, author: $author, title: $title, confidentiality: $confidentiality, attester: $attester, custodian: $custodian, relatesTo: $relatesTo, event: $event, section: $section)';
  }
...
class _$CompositionAttesterTearOff {
  ...
  _CompositionAttester call({List<String> mode, String time, Reference party}) {
...
abstract class $CompositionAttesterCopyWith<$Res> {
  ...
  $Res call({List<String> mode, String time, Reference party});
...
class _$CompositionAttesterCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      mode: mode == freezed ? _value.mode : mode as List<String>,
...
class _$_CompositionAttester implements _CompositionAttester {
  _$_CompositionAttester({this.mode, this.time, this.party});
...
class _$CompositionRelatesToTearOff {
  ...
  _CompositionRelatesTo call(
      {String code, Identifier targetIdentifier, Reference targetReference}) {
