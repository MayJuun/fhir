...
class _$CarePlanDetailCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      prohibited:
          prohibited == freezed ? _value.prohibited : prohibited as bool,
...
class _$_CareTeam implements _CareTeam {
  ...
  @override
  String toString() {
    return 'CareTeam(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, category: $category, name: $name, subject: $subject, context: $context, period: $period, participant: $participant, reasonCode: $reasonCode, reasonReference: $reasonReference, managingOrganization: $managingOrganization, note: $note)';
  }
...
class _$GoalCopyWithImpl<$Res> implements $GoalCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      statusDate:
          statusDate == freezed ? _value.statusDate : statusDate as DateTime,
      statusReason: statusReason == freezed
          ? _value.statusReason
          : statusReason as String,
...
class _$_Goal implements _Goal {
  ...
  @override
  String toString() {
    return 'Goal(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, category: $category, priority: $priority, description: $description, subject: $subject, startDate: $startDate, startCodeableConcept: $startCodeableConcept, target: $target, statusDate: $statusDate, statusReason: $statusReason, expressedBy: $expressedBy, addresses: $addresses, note: $note, outcomeCode: $outcomeCode, outcomeReference: $outcomeReference)';
  }
...
class _$ReferralRequestRequesterTearOff {
  ...
  _ReferralRequestRequester call({Reference agent, Reference onBehalfOf}) {
...
class _$_ReferralRequestRequester implements _ReferralRequestRequester {
  _$_ReferralRequestRequester({this.agent, this.onBehalfOf});
...
abstract class _ReferralRequestRequester implements ReferralRequestRequester {
  factory _ReferralRequestRequester({Reference agent, Reference onBehalfOf}) =
...
class _$ProcedureRequestRequesterTearOff {
  ...
  _ProcedureRequestRequester call({Reference agent, Reference onBehalfOf}) {
...
class _$_ProcedureRequestRequester implements _ProcedureRequestRequester {
  _$_ProcedureRequestRequester({this.agent, this.onBehalfOf});
...
abstract class _ProcedureRequestRequester implements ProcedureRequestRequester {
  factory _ProcedureRequestRequester({Reference agent, Reference onBehalfOf}) =
...
class _$_NutritionOrder implements _NutritionOrder {
  ...
  @override
  String toString() {
    return 'NutritionOrder(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, patient: $patient, encounter: $encounter, dateTime: $dateTime, orderer: $orderer, allergyIntolerance: $allergyIntolerance, foodPreferenceModifier: $foodPreferenceModifier, excludeFoodModifier: $excludeFoodModifier, oralDiet: $oralDiet, supplement: $supplement, enteralFormula: $enteralFormula)';
  }
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      encounter:
          encounter == freezed ? _value.encounter : encounter as Reference,
      dateWritten:
          dateWritten == freezed ? _value.dateWritten : dateWritten as String,
      prescriber:
...
class _$_VisionPrescription implements _VisionPrescription {
  ...
  @override
  String toString() {
    return 'VisionPrescription(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, patient: $patient, encounter: $encounter, dateWritten: $dateWritten, prescriber: $prescriber, reasonCodeableConcept: $reasonCodeableConcept, reasonReference: $reasonReference, dispense: $dispense)';
  }
...
class _$VisionPrescriptionDispenseCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      eye: eye == freezed ? _value.eye : eye as String,
      sphere: sphere == freezed ? _value.sphere : sphere as double,
      cylinder: cylinder == freezed ? _value.cylinder : cylinder as double,
      axis: axis == freezed ? _value.axis : axis as double,
      prism: prism == freezed ? _value.prism : prism as double,
...
class _$RequestGroupConditionTearOff {
  ...
  _RequestGroupCondition call(
      {String kind, String description, String language, String expression}) {
