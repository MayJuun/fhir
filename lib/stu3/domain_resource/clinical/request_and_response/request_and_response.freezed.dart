...
class _$DeviceRequestRequesterTearOff {
  ...
  _DeviceRequestRequester call({Reference agent, Reference onBehalfOf}) {
...
class _$_DeviceRequestRequester implements _DeviceRequestRequester {
  _$_DeviceRequestRequester({this.agent, this.onBehalfOf});
...
abstract class _DeviceRequestRequester implements DeviceRequestRequester {
  factory _DeviceRequestRequester({Reference agent, Reference onBehalfOf}) =
...
class _$_DeviceUseStatement implements _DeviceUseStatement {
  ...
  @override
  String toString() {
    return 'DeviceUseStatement(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, subject: $subject, whenUsed: $whenUsed, timingTiming: $timingTiming, timingPeriod: $timingPeriod, timingDateTime: $timingDateTime, recordedOn: $recordedOn, source: $source, device: $device, indication: $indication, bodySite: $bodySite, note: $note)';
  }
...
class _$CommunicationRequestRequesterTearOff {
  ...
  _CommunicationRequestRequester call({Reference agent, Reference onBehalfOf}) {
...
class _$_CommunicationRequestRequester
  ...
  _$_CommunicationRequestRequester({this.agent, this.onBehalfOf});
...
class _$_SupplyRequest implements _SupplyRequest {
  ...
  @override
  String toString() {
    return 'SupplyRequest(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, category: $category, priority: $priority, orderedItem: $orderedItem, occurrenceDateTime: $occurrenceDateTime, occurrencePeriod: $occurrencePeriod, occurrenceTiming: $occurrenceTiming, authoredOn: $authoredOn, requester: $requester, supplier: $supplier, reasonCodeableConcept: $reasonCodeableConcept, reasonReference: $reasonReference, deliverFrom: $deliverFrom, deliverTo: $deliverTo)';
  }
...
class _$SupplyRequestRequesterTearOff {
  ...
  _SupplyRequestRequester call({Reference agent, Reference onBehalfOf}) {
...
class _$_SupplyRequestRequester implements _SupplyRequestRequester {
  _$_SupplyRequestRequester({this.agent, this.onBehalfOf});
...
abstract class _SupplyRequestRequester implements SupplyRequestRequester {
  factory _SupplyRequestRequester({Reference agent, Reference onBehalfOf}) =
...
class _$_SupplyDelivery implements _SupplyDelivery {
  ...
  @override
  String toString() {
    return 'SupplyDelivery(id: $id, resourceType: $resourceType, identifier: $identifier, basedOn: $basedOn, partOf: $partOf, status: $status, patient: $patient, type: $type, suppliedItem: $suppliedItem, occurrenceDateTime: $occurrenceDateTime, occurrencePeriod: $occurrencePeriod, occurrenceTiming: $occurrenceTiming, supplier: $supplier, destination: $destination, receiver: $receiver)';
  }
