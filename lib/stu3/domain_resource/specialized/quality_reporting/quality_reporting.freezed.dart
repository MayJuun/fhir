...
class _$_MeasureReport implements _MeasureReport {
  ...
  @override
  String toString() {
    return 'MeasureReport(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, type: $type, measure: $measure, patient: $patient, date: $date, reportingOrganization: $reportingOrganization, period: $period, group: $group, evaluatedResources: $evaluatedResources)';
  }
...
class _$_MeasureReportGroup implements _MeasureReportGroup {
  _$_MeasureReportGroup(
      {this.identifier, this.population, this.measureScore, this.stratifier});
...
class _$_MeasureReportStratum implements _MeasureReportStratum {
  _$_MeasureReportStratum({this.value, this.population, this.measureScore});
...
abstract class _MeasureReportStratum implements MeasureReportStratum {
  factory _MeasureReportStratum(
      {String value,
      List<MeasureReportPopulation1> population,
      double measureScore}) = _$_MeasureReportStratum;
    ...
    return identical(this, other) ||
        (other is _Measure &&
            ...
            (identical(other.disclaimer, disclaimer) ||
                const DeepCollectionEquality().equals(other.disclaimer, disclaimer)) &&
...
class _$_MeasureStratifier implements _MeasureStratifier {
  _$_MeasureStratifier({this.identifier, this.criteria, this.path});
