...
class _$_ResearchSubject implements _ResearchSubject {
  ...
  @override
  String toString() {
    return 'ResearchSubject(id: $id, resourceType: $resourceType, identifier: $identifier, status: $status, period: $period, study: $study, individual: $individual, assignedArm: $assignedArm, actualArm: $actualArm, consent: $consent)';
  }
...
class _$_ResearchStudy implements _ResearchStudy {
  ...
  @override
  String toString() {
    return 'ResearchStudy(id: $id, resourceType: $resourceType, identifier: $identifier, title: $title, protocol: $protocol, partOf: $partOf, status: $status, category: $category, focus: $focus, contact: $contact, relatedArtifact: $relatedArtifact, keyword: $keyword, jurisdiction: $jurisdiction, description: $description, enrollment: $enrollment, period: $period, sponsor: $sponsor, principalInvestigator: $principalInvestigator, site: $site, reasonStopped: $reasonStopped, note: $note, arm: $arm)';
  }
...
class _$_ResearchStudyArm implements _ResearchStudyArm {
  _$_ResearchStudyArm({this.name, this.code, this.description});
