...
class _$ActivityDefinitionParticipantTearOff {
  ...
  _ActivityDefinitionParticipant call({String type, CodeableConcept role}) {
...
abstract class $ActivityDefinitionParticipantCopyWith<$Res> {
  ...
  $Res call({String type, CodeableConcept role});
...
class _$_ActivityDefinitionParticipant
  ...
  _$_ActivityDefinitionParticipant({this.type, this.role});
...
abstract class _ActivityDefinitionParticipant
  ...
  factory _ActivityDefinitionParticipant({String type, CodeableConcept role}) =
...
class _$_Questionnaire implements _Questionnaire {
  ...
  @override
  String toString() {
    return 'Questionnaire(id: $id, resourceType: $resourceType, url: $url, identifier: $identifier, version: $version, name: $name, title: $title, status: $status, experimental: $experimental, date: $date, publisher: $publisher, description: $description, purpose: $purpose, approvalDate: $approvalDate, lastReviewDate: $lastReviewDate, effectivePeriod: $effectivePeriod, useContext: $useContext, jurisdiction: $jurisdiction, contact: $contact, copyright: $copyright, code: $code, subjectType: $subjectType, item: $item)';
  }
...
mixin _$QuestionnaireItem {
  ...
  bool get initialBoolean;
  double get initialDecimal;
  int get initialInteger;
...
class _$QuestionnaireItemCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      required: required == freezed ? _value.required : required as bool,
...
class _$QuestionnaireEnableWhenCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      hasAnswer: hasAnswer == freezed ? _value.hasAnswer : hasAnswer as bool,
      ...
      answerDate:
          answerDate == freezed ? _value.answerDate : answerDate as DateTime,
      answerDateTime: answerDateTime == freezed
          ? _value.answerDateTime
          : answerDateTime as DateTime,
      answerTime:
          answerTime == freezed ? _value.answerTime : answerTime as String,
...
class _$_ServiceDefinition implements _ServiceDefinition {
  ...
  @override
  String toString() {
    return 'ServiceDefinition(id: $id, resourceType: $resourceType, url: $url, identifier: $identifier, version: $version, name: $name, title: $title, status: $status, experimental: $experimental, date: $date, publisher: $publisher, description: $description, purpose: $purpose, usage: $usage, approvalDate: $approvalDate, lastReviewDate: $lastReviewDate, effectivePeriod: $effectivePeriod, useContext: $useContext, jurisdiction: $jurisdiction, topic: $topic, contributor: $contributor, contact: $contact, copyright: $copyright, relatedArtifact: $relatedArtifact, trigger: $trigger, dataRequirement: $dataRequirement, operationDefinition: $operationDefinition)';
  }
...
class _$_PlanDefinition implements _PlanDefinition {
  ...
  @override
  String toString() {
    return 'PlanDefinition(id: $id, resourceType: $resourceType, url: $url, identifier: $identifier, version: $version, name: $name, title: $title, type: $type, status: $status, experimental: $experimental, date: $date, publisher: $publisher, description: $description, purpose: $purpose, usage: $usage, approvalDate: $approvalDate, lastReviewDate: $lastReviewDate, effectivePeriod: $effectivePeriod, useContext: $useContext, jurisdiction: $jurisdiction, topic: $topic, contributor: $contributor, contact: $contact, copyright: $copyright, relatedArtifact: $relatedArtifact, library: $library, goal: $goal, action: $action)';
  }
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      documentation: documentation == freezed
          ? _value.documentation
          : documentation as List<RelatedArtifact>,
      goalId: goalId == freezed ? _value.goalId : goalId as List<String>,
...
class _$PlanDefinitionParticipantTearOff {
  ...
  _PlanDefinitionParticipant call({String type, CodeableConcept role}) {
...
class _$_PlanDefinitionParticipant implements _PlanDefinitionParticipant {
  _$_PlanDefinitionParticipant({this.type, this.role});
...
abstract class _PlanDefinitionParticipant implements PlanDefinitionParticipant {
  factory _PlanDefinitionParticipant({String type, CodeableConcept role}) =
