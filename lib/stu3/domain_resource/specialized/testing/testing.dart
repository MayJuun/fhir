...
factory TestScript_Rule.fromJson(Map<String, dynamic> json) => _$TestScript_RuleFromJson(json);
...
factory TestScript_Param.fromJson(Map<String, dynamic> json) => _$TestScript_ParamFromJson(json);
...
factory TestScript_Ruleset.fromJson(Map<String, dynamic> json) => _$TestScript_RulesetFromJson(json);
...
factory TestScript_Rule1.fromJson(Map<String, dynamic> json) => _$TestScript_Rule1FromJson(json);
...
factory TestScript_Param1.fromJson(Map<String, dynamic> json) => _$TestScript_Param1FromJson(json);
...
factory TestScript_Rule2.fromJson(Map<String, dynamic> json) => _$TestScript_Rule2FromJson(json);
...
factory TestScript_Param2.fromJson(Map<String, dynamic> json) => _$TestScript_Param2FromJson(json);
...
factory TestScript_Ruleset1.fromJson(Map<String, dynamic> json) => _$TestScript_Ruleset1FromJson(json);
...
factory TestScript_Rule3.fromJson(Map<String, dynamic> json) => _$TestScript_Rule3FromJson(json);
...
factory TestScript_Param3.fromJson(Map<String, dynamic> json) => _$TestScript_Param3FromJson(json);
