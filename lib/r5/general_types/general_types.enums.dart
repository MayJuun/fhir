...
secondary,@JsonValue('old')
old,@JsonValue('unknown')
  unknown,}
...
work,@JsonValue('temp')
temp,@JsonValue('old')
old,@JsonValue('billing')
billing,@JsonValue('unknown')
  unknown,}
...
@JsonValue('MORN')
morn,@JsonValue('MORN.early')
morn_early,@JsonValue('MORN.late')
morn_late,@JsonValue('NOON')
noon,@JsonValue('AFT')
aft,@JsonValue('AFT.early')
aft_early,@JsonValue('AFT.late')
aft_late,@JsonValue('EVE')
eve,@JsonValue('EVE.early')
eve_early,@JsonValue('EVE.late')
eve_late,@JsonValue('NIGHT')
night,@JsonValue('PHS')
phs,@JsonValue('HS')
hs,@JsonValue('WAKE')
wake,@JsonValue('C')
