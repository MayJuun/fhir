...
entered_in_error,@JsonValue('checked-in')
checked_in,@JsonValue('waitlist')
waitlist,@JsonValue('unknown')
  unknown,}


enum AppointmentParticipantRequired{
@JsonValue('required')
required_,@JsonValue('optional')
...
enum TaskIntent{
@JsonValue('unknown')
unknown,@JsonValue('proposal')
proposal,@JsonValue('plan')
plan,@JsonValue('order')
order,@JsonValue('original-order')
original_order,@JsonValue('reflex-order')
reflex_order,@JsonValue('filler-order')
filler_order,@JsonValue('instance-order')
instance_order,@JsonValue('option')
option,}
