...
individual,@JsonValue('subject-list')
subject_list,@JsonValue('summary')
summary,@JsonValue('data-collection')
data_collection,@JsonValue('unknown')
  unknown,}
...
get_,@JsonValue('options')
options,@JsonValue('patch')
patch,@JsonValue('post')
post,@JsonValue('put')
put,@JsonValue('head')
head,@JsonValue('unknown')
  unknown,}
