...
@freezed
abstract class ConditionDefinition with Resource  implements _$ConditionDefinition {
...
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
  ...
  @JsonKey(name: '_name')   Element nameElement,
   String title,
  @JsonKey(name: '_title')   Element titleElement,
@JsonKey(unknownEnumValue: ConditionDefinitionStatus.unknown) ConditionDefinitionStatus status,
  @JsonKey(name: '_status')   Element statusElement,
   Boolean experimental,
  @JsonKey(name: '_experimental')   Element experimentalElement,
   FhirDateTime date,
 ...
 factory ConditionDefinition.fromJson(Map<String,dynamic> json) => _$ConditionDefinitionFromJson(json);
}

@freezed
abstract class ConditionDefinitionObservation  implements _$ConditionDefinitionObservation {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory ConditionDefinitionObservation.fromJson(Map<String,dynamic> json) => _$ConditionDefinitionObservationFromJson(json);
}

@freezed
abstract class ConditionDefinitionMedication  implements _$ConditionDefinitionMedication {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory ConditionDefinitionMedication.fromJson(Map<String,dynamic> json) => _$ConditionDefinitionMedicationFromJson(json);
}

@freezed
abstract class ConditionDefinitionPrecondition  implements _$ConditionDefinitionPrecondition {
ConditionDefinitionPrecondition._();
factory ConditionDefinitionPrecondition({
   String id,
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
   List<FhirExtension> modifierExtension,
@JsonKey(unknownEnumValue: ConditionDefinitionPreconditionType.unknown) ConditionDefinitionPreconditionType type,
  @JsonKey(name: '_type')   Element typeElement,
   @required CodeableConcept code,
 ...
 factory ConditionDefinitionPrecondition.fromJson(Map<String,dynamic> json) => _$ConditionDefinitionPreconditionFromJson(json);
}

@freezed
abstract class ConditionDefinitionQuestionnaire  implements _$ConditionDefinitionQuestionnaire {
ConditionDefinitionQuestionnaire._();
factory ConditionDefinitionQuestionnaire({
   String id,
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
   List<FhirExtension> modifierExtension,
@JsonKey(unknownEnumValue: ConditionDefinitionQuestionnairePurpose.unknown) ConditionDefinitionQuestionnairePurpose purpose,
  @JsonKey(name: '_purpose')   Element purposeElement,
   @required Reference reference,
}) = _ConditionDefinitionQuestionnaire;

 factory ConditionDefinitionQuestionnaire.fromJson(Map<String,dynamic> json) => _$ConditionDefinitionQuestionnaireFromJson(json);
}
...
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
 ...
 factory ConditionDefinitionPlan.fromJson(Map<String,dynamic> json) => _$ConditionDefinitionPlanFromJson(json);
}
...
@freezed
abstract class ObservationDefinitionComponent  implements _$ObservationDefinitionComponent {
...
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
 ...
 factory ObservationDefinitionComponent.fromJson(Map<String,dynamic> json) => _$ObservationDefinitionComponentFromJson(json);
}
