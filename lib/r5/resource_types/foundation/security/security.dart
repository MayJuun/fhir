...
Permission._();
factory Permission({
@JsonKey(defaultValue: 'Permission') @required String resourceType,
   Id id,
   Meta meta,
   FhirUri implicitRules,
  @JsonKey(name: '_implicitRules')   Element implicitRulesElement,
...
@freezed
abstract class PermissionProcessingActivity  implements _$PermissionProcessingActivity {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory PermissionProcessingActivity.fromJson(Map<String,dynamic> json) => _$PermissionProcessingActivityFromJson(json);
}
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory PermissionJustification.fromJson(Map<String,dynamic> json) => _$PermissionJustificationFromJson(json);
}
