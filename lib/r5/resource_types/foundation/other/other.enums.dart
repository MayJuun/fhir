...
collection,@JsonValue('subscription-notification')
subscription_notification,@JsonValue('unknown')
  unknown,}
...
delete,@JsonValue('PATCH')
patch,@JsonValue('unknown')
  unknown,}
...
duplicate,@JsonValue('multiple-matches')
multiple_matches,@JsonValue('not-found')
not_found,@JsonValue('deleted')
...
timeout,@JsonValue('incomplete')
incomplete,@JsonValue('throttled')
...
@JsonValue('empty')
empty,@JsonValue('id-only')
id_only,@JsonValue('full-resource')
full_resource,@JsonValue('unknown')
  unknown,}


enum SubscriptionStatusType{
@JsonValue('handshake')
handshake,@JsonValue('heartbeat')
heartbeat,@JsonValue('event-notification')
event_notification,@JsonValue('query-status')
query_status,@JsonValue('unknown')
  unknown,}
