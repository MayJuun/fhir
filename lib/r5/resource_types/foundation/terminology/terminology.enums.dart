...
related_to,@JsonValue('equivalent')
equivalent,@JsonValue('broader')
broader,@JsonValue('narrower')
narrower,@JsonValue('not-related-to')
not_related_to,@JsonValue('unknown')
  unknown,}
