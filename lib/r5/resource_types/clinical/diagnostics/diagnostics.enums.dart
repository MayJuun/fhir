...
@JsonValue('registered')
registered,@JsonValue('available')
available,@JsonValue('cancelled')
cancelled,@JsonValue('entered-in-error')
entered_in_error,@JsonValue('unknown')
unknown,}
...
@JsonValue('sense')
sense,@JsonValue('antisense')
antisense,@JsonValue('unknown')
  unknown,}


enum MolecularSequenceReferenceSeqStrand{
@JsonValue('watson')
watson,@JsonValue('crick')
crick,@JsonValue('unknown')
  unknown,}
