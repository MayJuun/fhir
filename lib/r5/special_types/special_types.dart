...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory CodeableReference.fromJson(Map<String,dynamic> json) => _$CodeableReferenceFromJson(json);
}
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory StatisticSampleSize.fromJson(Map<String,dynamic> json) => _$StatisticSampleSizeFromJson(json);
}

@freezed
abstract class StatisticAttributeEstimate  implements _$StatisticAttributeEstimate {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory StatisticAttributeEstimate.fromJson(Map<String,dynamic> json) => _$StatisticAttributeEstimateFromJson(json);
}

@freezed
abstract class StatisticAttributeEstimate1  implements _$StatisticAttributeEstimate1 {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory StatisticAttributeEstimate1.fromJson(Map<String,dynamic> json) => _$StatisticAttributeEstimate1FromJson(json);
}

@freezed
abstract class StatisticModelCharacteristic  implements _$StatisticModelCharacteristic {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory StatisticModelCharacteristic.fromJson(Map<String,dynamic> json) => _$StatisticModelCharacteristicFromJson(json);
}
...
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
 ...
 factory StatisticVariable.fromJson(Map<String,dynamic> json) => _$StatisticVariableFromJson(json);
}
...
@JsonKey(name: 'extension')   List<FhirExtension> extension_,
 ...
 factory OrderedDistribution.fromJson(Map<String,dynamic> json) => _$OrderedDistributionFromJson(json);
}

@freezed
abstract class OrderedDistributionInterval  implements _$OrderedDistributionInterval {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory OrderedDistributionInterval.fromJson(Map<String,dynamic> json) => _$OrderedDistributionIntervalFromJson(json);
}
