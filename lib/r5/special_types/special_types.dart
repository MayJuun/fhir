...
@freezed
abstract class StatisticEstimateQualifier  implements _$StatisticEstimateQualifier {
...
@JsonKey(name: 'extension')  List<FhirExtension> extension_,
 ...
 factory StatisticEstimateQualifier.fromJson(Map<String,dynamic> json) => _$StatisticEstimateQualifierFromJson(json);
}

@freezed
abstract class OrderedDistribution with Resource  implements _$OrderedDistribution {
