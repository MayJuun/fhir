...
class _$_Base extends _Base {
  const _$_Base({this.id, @JsonKey(name: 'extension') this.extension_})
      : super._();
...
class _$_PrimitiveType extends _PrimitiveType {
  const _$_PrimitiveType({this.id, @JsonKey(name: 'extension') this.extension_})
      : super._();
...
abstract class _PrimitiveType extends PrimitiveType {
  const _PrimitiveType._() : super._();
  const factory _PrimitiveType(
          {String id,
...
class _$_DataType extends _DataType {
  const _$_DataType({this.id, @JsonKey(name: 'extension') this.extension_})
      : super._();
