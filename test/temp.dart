...
final tempMap = {
  ...
  "foodPreferenceModifier": [
    {
      "coding": [
        {"system": "http://hl7.org/fhir/diet", "code": "dairy-free"}
      ]
    }
  ],
  "excludeFoodModifier": [
  ...
  "oralDiet": {
    "fhir_comments": ["   EH: use oral Diet element   "],
    "type": [
      {
        "fhir_comments": [
